...
<ul class="list-group">
    <li class="list-group-item">Date/Time Endorse: {{ $dateTimeEndorse }}</li>
    <li class="list-group-item">Account Name: {{ $acctName }}</li>
    <li class="list-group-item">Address: {{ $address }}</li>
    <li class="list-group-item">Name of Requestor: {{ $nameOfRequestor }}</li>
    <li class="list-group-item">Type of Loan: {{ $typeOfLoan }}</li>
    <li class="list-group-item">Type of Request: {{ $typeOfRequest }}</li>
    <li class="list-group-item">Client Remarks: {{ $remarks }}</li>
</ul>
