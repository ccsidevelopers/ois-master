...
<br>
<p class="greet">Good Day!</p><br>
<p>Here's the details of the accounts of the bulk endorsement:</p>

@for($ctr = 0; $ctr < $countLoop; $ctr++)
    <p class="greet">Account Name: <b>{{$bulkData[$ctr]['acct_name']}}</b></p>
    <p class="greet">Endorsed By: <b>{{$bulkData[$ctr]['acct_poc']}}</b></p>
    <p class="greet">From: <b>{{$bulkData[$ctr]['acct_site']}}</b></p>
    <p class="greet">Date/Time Occured: <b>{{$bulkData[$ctr]['acct_date']}}</b></p>
    <br>
    <br>
@endfor
...
<p style="color: black"><b><i>PS: THIS IS <u>GENERATED EMAIL</u> FROM CCSI - Online Information Managemement System PLEASE DO NOT REPLY TO THIS EMAIL.</i></b></p>
<p>
    <b>Kind Regards,</b>
</p>
