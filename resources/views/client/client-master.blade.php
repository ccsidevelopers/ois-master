            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <h5>Please wait while bulk request is being sent... <img src="{{asset('dist/img/loading.gif')}}" style = "width : 3%" id="loadingBulkSend"></h5>
                        </div>
                        <div class ="col-md-2"></div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-body">
                                    ...
                                    {{--<div class="row">--}}
                                    {{--<div class="col-md-2"></div>--}}
                                    {{--<div class="col-md-8" id="paypal-button">--}}
                                    {{--<div class="col-md-12" id="paypal-payment"></div>--}}
                                    {{--</div>--}}
                                    {{--<div class="col-md-2"></div>--}}
                                    {{--</div>--}}
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class ="col-md-2"></div>
                        <div class="col-md-8">
                            <h5>Please wait while checking for double endorse and accuracy of data...<img src="{{asset('dist/img/loading.gif')}}" style = "width : 3%"></h5>
                        </div>
                        <div class ="col-md-2"></div>
                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <select id="" class="form-control edit_endo_roll" identifier="type_of_loan">
                                                        @foreach($tols as $tol)
                                                        <option value="{{strtoupper($tol["type_of_loans"])}}">{{$tol["type_of_loans"]}}</option>
                                                        @endforeach
                                                        @if(preg_match('/TFS/', Auth::user()->name))
