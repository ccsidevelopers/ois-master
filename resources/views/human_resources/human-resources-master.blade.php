...
@section('content')
    ...
    {{--SUCCESS Update contract stat MODAL--}}
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class = "row" style = "padding-top : 20px;">
                        <div class = "col-md-12">
                            <h5 style="text-align: center">Please wait while request is being sent.  <img src="{{ asset('dist/img/loading.gif') }}" style="width: 5%;"></h5>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                                      ...
                                      <div class="col-md-12">
                                          <div class="form-group">
                                              <select name="" class="select2" id="specific_date_generate" style="width:100%">
                                                  <option value="">-</option>
                                                  @foreach($get_employee_id as $chunkdata)
                                                      <option value="{{$chunkdata->emp_id}}">{{$chunkdata->emp_name}}</option>
                                                  @endforeach
                                              </select>
                                          </div>
                                      </div>
...
@push('leftsidebar')
    @include('human_resources.human-resources-leftsidebar')
@endpush

@push('jscript')
    <link rel="stylesheet" href="https://cdn.datatables.net/responsive/1.0.7/css/responsive.dataTables.min.css">
    <script src="https://cdn.datatables.net/responsive/2.1.1/js/dataTables.responsive.min.js"></script>
    <script src="{{ asset('jscript/human-resources.js?n='.$javs) }}"></script>
