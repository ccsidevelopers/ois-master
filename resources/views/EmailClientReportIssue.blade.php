...
<br>
<p>Data of Report: ({{$datenow}})</p>
<ul class="list-group">

    <li class="list-group-item">Title: {{ $title }}</li>
    <li class="list-group-item">Message: {{ $messages }}<br><br></li>
</ul>
<h2> Account Information </h2>
<ul class="list-group">
    <li class="list-group-item">ID: {{ $id }}</li>
    <li class="list-group-item">Date Endorsed: {{ $date_endorsed }}</li>
    <li class="list-group-item">Time Endorsed: {{ $time_endorsed }}</li>
    <li class="list-group-item">Re Ci: {{ $re_ci }}</li>
    ...
    <li class="list-group-item">Client Remarks: {{ $client_remarks }}</li>
    <li class="list-group-item">Note: {{ $nonotes }}</li>
    <li class="list-group-item">Status: {{ $endorsement_status_internal }}</li>
</ul>
