...
<br>
<p>Transferred by SAO</p>
<ul class="list-group">
    <li class="list-group-item">Transferred by: {{ $saoname }}</li>
    <li class="list-group-item">From AO: {{ $from_aoname }}</li>
    <li class="list-group-item">To AO: {{ $to_aoname }}</li>
