...
<ul class="list-group">
    @for($ctr = 0; $ctr < $countLoop; $ctr++)
        ...
        <li class="list-group-item">Account Name: {{ $bulkData[$ctr]['acctName'] }}</li>
        <li class="list-group-item">Address: {{ $bulkData[$ctr]['acctAddress'] }}</li>
        ...
        <li class="list-group-item">Type of Request: {{ $bulkData[$ctr]['tOR'] }}</li>
        <br>
        <br>
    @endfor
</ul>
