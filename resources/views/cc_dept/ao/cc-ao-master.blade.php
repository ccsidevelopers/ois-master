...
@section('content')
    ...
    <div class="modal modal-normal fade" id="modal-cc-ao-assign">
    ...
    <div class="modal modal-normal fade" id="modal-cc-ao-upload-update">
        <div class="modal-dialog" style = "width : 40%;">
            <div class="modal-content">
                        ...
                        <div class = "col-md-12">
                            <div class = "box box-danger">
                                ...
                                <div class = "row" style = "padding-top : 20px">
                                    ...
                                    <div class = "col-md-6">
                                        <h4>Note: Please click the button below to download current file.</h4>
                                    </div>
                                    <div class = "col-md-3"></div>
                                </div>
                                <div class="row" style = "padding-top : 20px;">
                ...
                <div class="modal-footer">
                    <a class="btn btn-md btn-info pull-right" id="btnUpdateSaoToTele">Update</a>
                </div>
            </div>
        </div>
    </div>

    <div class="modal fade" id="modal-cc-ao-send-report">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            ...
                            <div class = "box box-warning">
                                <div class = "row" style = "padding-top : 20px;">
                                    <div class = "col-md-7">
                                        ...
                                        <input type="file" id = "cc_ao_send_file_report">
                                        <span id="ulPercentage_ao">--</span>
                                        <div id="progressbar_ao" hidden></div>
                                    </div>
                                </div>
                                <div class = "row" style = "padding-top : 10px">
                                    <div class = "col-md-12">
                                        <label for="">Remarks: </label>
                                        <textarea   rows="6" class = "form-control" id = "cc_ao_report_remarks"></textarea>
                                    </div>
                                </div>
                                <div class = "row" style = "padding-top : 10px">
                                    <div class = "col-md-8">
                                        <label for="">Status: </label>
                                        <select class = "form-control" id = "cc_ao_report_status">
                ...
                <div class="modal-footer">
                    <i id="loadingSend"></i>
                    <button type="button" class="btn btn-primary" id = "cc_ao_send_report">Send Report</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
                            ...
                            <div class = "box box-warning">
                                <div class = "row" style = "padding-top : 20px">
                                    <div class = "col-md-12">
                                        ...
                                        <textarea rows="6" class = "form-control" id = "cc_ao_view_report_remarks" disabled></textarea>
                                    </div>
    ...
    <div class="modal fade" id="modal-transfer-tele">
        <div class="modal-dialog" style = "width : 50%;">
            <div class="modal-content">
                            ...
                            <div class = "box box-danger">
                                <div class = "row" style = "padding-top : 30px;  padding-bottom : 20px;">
                                    ...
                                    <div class = "col-md-4">
                                        ...
                                        <input type="text" class = "form-control" ID = "ao-acct-tele-assigned" disabled>
                                    </div>
                                    <div class = "col-md-2"></div>
                                    <div class = "col-md-4">
                                        <label for="">Transfer Account to:</label>
                                        <select class = "form-control" id = "tele-list-assign-acct">
                ...
                <div class="modal-footer">
                    <i id="lodadingAssignTele" style="position: absolute;"></i>
    ...
    {{--<div class="form-group">--}}
    {{--<center><label>Select Lacking Documents/Attachments</label>--}}
    {{--<table class="table-condensed table-hover" width="40%" id="tblCheckings">--}}
    {{--<tr>--}}
    {{--<th>Documents/Attachments</th>--}}
    {{--</tr>--}}
    {{--</table>--}}
    {{--<div class="form-group" style="margin-top:10px;">--}}
    {{--<textarea rows="5" class="form-control" placeholder="Remarks here...." style="resize: none; width: 40%;" id="remarksText"></textarea>--}}
    {{--</div>--}}
    {{--</center>--}}
    {{--</div>--}}
    {{--</div>--}}
...
@push('leftsidebar')
    @include('cc_dept.ao.cc-ao-leftsidebar')
@endpush

@push('jscript')
    <link rel="stylesheet" href="https://cdn.datatables.net/responsive/1.0.7/css/responsive.dataTables.min.css">
    <script src="https://cdn.datatables.net/responsive/2.1.1/js/dataTables.responsive.min.js"></script>
    <script src="https://cdn.datatables.net/rowreorder/1.2.0/js/dataTables.rowReorder.min.js"></script>w
    <script src="{{ asset('jscript/cc-ao.js?n='.$javs) }}"></script>
