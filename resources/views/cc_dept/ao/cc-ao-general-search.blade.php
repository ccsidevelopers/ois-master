<div class="content-wrapper">
    <section class="content-header">
        <h1>
            CC Account Officer - General  Search Accounts
        </h1>
    </section>
    ...
    <section class="content">
        <div class="box">
            <div class="box-body">
                ...
                <div class="col-md-12">
                    <table id="cc_ao_generaltbl" class="tableendorse table-hover table-condensed dataTable dtr-inline" role="grid" aria-describedby="cc_sao_generaltbl_info" style="width: 100%;">
                        <thead>
                        <tr>
                            <th>ID</th>
                            <th>SITE</th>
