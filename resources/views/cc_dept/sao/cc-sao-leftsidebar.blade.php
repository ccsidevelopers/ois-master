<aside class="main-sidebar affix">
    ...
    <!-- search form -->
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            {{--<li class="">--}}
            {{--<a href="#cc_sao_dash"  data-toggle="tab" class="cc_sao_side_class">--}}
...
<div class="tab-content">
    ...
    <div class="tab-pane active" id="cc_sao_accounts">
        @include('cc_dept.sao.cc-sao-accounts')
    </div>
    <div class="tab-pane" id="cc_sao_dash">
        @include('cc_dept.sao.cc-sao-dashboard')
    </div>
    <div class="tab-pane" id="cc_sao_general_mon">
        @include('cc_dept.sao.cc-sao-gen-monitoring')
    </div>
    <div class="tab-pane" id="cc_sao_general_search">
        @include('cc_dept.sao.cc-sao-general-search')
    </div>
    <div class="tab-pane" id="cc_sao_bi_reports">
        @include('cc_dept.sao.cc-sao-bi-reports')
    </div>
