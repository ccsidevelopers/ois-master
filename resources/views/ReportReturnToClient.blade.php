...
<br>
    ...
    <p class="greet">Account <b>{{$account_name}}</b> was returned due:</p>
    <ul class="list-group">@foreach($remarks as $rems)<li class="list-group-item">{{$rems}}</li>@endforeach</ul>
    <br>
    ...
    @if($sender_position == 'Senior Account Officer' || $sender_position == 'Account Officer')
