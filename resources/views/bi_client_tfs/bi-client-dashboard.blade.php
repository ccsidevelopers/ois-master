                        ...
                        <div class = "tab-content">
                            <div class="tab-pane active" id="tab_aa">
                                <div class="box-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <table id="bi_client_general_table" class="tableendorse table-hover table-condensed edit_funq" width="100%">
                                                <thead>
                                                <tr>
                                                    <th>ACTION</th>
                                                    <th>Party #</th>
                            ...
                            <div class="tab-pane " id="tab_b">
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <table id="bi_client_pending_table" class="tableendorse table-hover table-condensed edit_funq" width="100%">
                                                <thead>
                                                <tr>
                                                    <th>ACTION</th>
                                                    <th>SITE</th>
