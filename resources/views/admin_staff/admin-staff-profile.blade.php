    ...
    <section class = "content">
        <div class = "nav-tabs-custom">
            <ul class = "nav nav-tabs">
                {{--<li id = "removeAddAdmin" class = "active"><a id = "tab2" href="#tab_eq2" data-toggle="tab" class = "admin_staff_eq_class">Add/Edit Item</a></li>--}}
                {{--<li id = "removeAssignView"><a id = "tab3" href="#tab_eq3" data-toggle="tab" class = "admin_staff_eq_class">Assigning of Items</a></li>--}}
                        ...
                        <div class = "col-md-5" id = "addItemSize">
                            <div class="box box-info" style = "padding-top: 30px;">
                                ...
                                <div class = "row">
                                    <center>
                                        <form id="form1">
                                            <img id = "item_profile_pic_display"  style = "width: 30%; height: 30%; border:5px solid #000; " src = "{{asset('item_pic/items.jpg')}}" />
                                        </form>
                                    </center>
                                </div>
