...
@section('content')
                        ...
                        <div class = "col-md-6">
                            <div class = "box box-warning">
                                <div class = "box box-default">
                                    <center><img id = "item_pic" src = "{{asset('user_profile_pictures/default3.jpg')}}" style = "width: 220px; height: 240px;padding: 20px 0 20px 0;"></center>
                    ...
                    <div class = "box-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="box box-info">
                                    <center>
                                        <img id = "emp_show_pic_me_req" style="padding: 10px" class="img-circle" src = "{{asset('user_profile_pictures/default3.jpg')}}"/>
                    ...
                    <div class = "box-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="box box-info">
                                    <center>
                                        <img id = "emp_show_pic_me" style="padding: 10px" class="img-circle" src = "{{asset('user_profile_pictures/default3.jpg')}}"/>
                                        <p id = "nameStorage"></p>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    {{--<center><h4 class="modal-title" >Add Item</h4></center>--}}
                </div>
                <div class="modal-body">
    ...
    {{--<div class="modal fade" id="modal-po_form">--}}
        {{--<div class="modal-dialog" style = "width : 50%">--}}
            {{--<div class="modal-content">--}}
                {{--<div class="modal-body">--}}
                    {{--<div class = "row" style = "padding-top : 30px;">--}}
                        {{--<div class = "col-md-12">--}}
                            {{--<table class="table-condensed" style = "overflow-x:auto; border-collapse:collapse; table-layout:fixed; width : 100%">--}}
                                {{--<tr>--}}
                                    {{--<th colspan="4" style = "background-color: darkgrey; color : black; "><h4 style= "font-weight:bold;">PURCHASE ORDER FORM</h4>--}}
                                        {{--<h5><b>P.O No. : </b><input type="text" ></h5></th>--}}
                                {{--</tr>--}}
                                {{--<tr>--}}
                                    {{--<td colspan="2" style="font-weight:bold;"><span class = "pull-left toLeftTop">P.O Date :</span> </td>--}}
                                    {{--<td colspan = "2"><input type="date" class = "form-control"></td>--}}
                                {{--</tr>--}}
                                {{--<tr>--}}
                                    {{--<td colspan="2" style="font-weight:bold;"><span class = "pull-left toLeftTop">Recommended Supplier/Vendor's Name :</span> </td>--}}
                                    {{--<td colspan = "2"><input type="text" class = "form-control"></td>--}}
                                {{--</tr>--}}
                                {{--<tr>--}}
                                    {{--<td colspan="2" style="font-weight:bold;"><span class = "pull-left toLeftTop">Contact Person :</span> </td>--}}
                                    {{--<td colspan = "2"><input type="text" class = "form-control"></td>--}}
                                {{--</tr>--}}
                                {{--<tr>--}}
                                    {{--<td colspan="2" style="font-weight:bold;"><span class = "pull-left toLeftTop">Address :</span> </td>--}}
                                ...
                                {{--</tr>--}}
                                {{--<tr>--}}
                                    {{--<td colspan="2" style="font-weight:bold;"><span class = "pull-left toLeftTop">Date of Accreditation :</span> </td>--}}
                                    {{--<td colspan = "2"><input type="date" class = "form-control"></td>--}}
                                {{--</tr>--}}
                                {{--<tr>--}}
                                    {{--<td colspan="2" style="font-weight:bold;"><span class = "pull-left toLeftTop">Terms of payment :</span> </td>--}}
                                    {{--<td colspan = "2"><input type="text" class = "form-control"></td>--}}
                                {{--</tr>--}}
                                {{--<tr>--}}
                                    {{--<td colspan="2" style="font-weight:bold;"><span class = "pull-left toLeftTop">Date of Delivery :</span> </td>--}}
                                    {{--<td colspan = "2"><input type="date" class = "form-control"></td>--}}
                                {{--</tr>--}}
                            {{--</table>--}}
                            {{--<table class="table-condensed" style = "overflow-x:auto; border-collapse:collapse; table-layout:fixed; width : 100%" id = "brandItemsTable2">--}}
                                ...
                                {{--<tr id = "removeBrand1-0">--}}
                                    {{--<td colspan="1"><textarea class = "form-control" rows ="2"></textarea></td>--}}
                                    {{--<td colspan="1"><input type="number" class="form-control"></td>--}}
                                    {{--<td colspan="1"><input type="number" class="form-control"></td>--}}
                                    {{--<td colspan="1"><div class="input-group input-group-sm"><input type="number" class="form-control">--}}
                    ...
                    {{--<div class = "row">--}}
                        {{--<div class = "col-md-6">--}}
                            {{--<table class="table-condensed" style = "overflow-x:auto; border-collapse:collapse; table-layout:fixed; width : 100%; margin-top : 60px;" >--}}
                                {{--<tr>--}}
                                    {{--<th colspan="1" style = "background-color: darkgrey; color : black; ">Additional Notes </th>--}}
                                {{--</tr>--}}
                                {{--<tr>--}}
                                    {{--<td colspan="1" ><textarea class = "form-control" rows ="1"></textarea></td>--}}
                                {{--</tr>--}}
                                {{--<tr>--}}
                                    {{--<td colspan="1" ><textarea class = "form-control" rows ="1"></textarea></td>--}}
                                {{--</tr>--}}
                    ...
                    {{--<div class = "row" style = "padding-top : 30px;">--}}
                        {{--<div class = "col-md-12">--}}
                            {{--<table class="table-condensed" style = "overflow-x:auto; border-collapse:collapse; table-layout:fixed; width : 100%">--}}
                                ...
                                {{--</tr>--}}
                                {{--<tr>--}}
                                    {{--<td colspan="1" ><span class="toLeftTop2 pull-left"><input type="checkbox"> <b>Attach the approved requisition and agreement/proposal</b></span></td>--}}
                                {{--</tr>--}}
                                {{--<tr>--}}
                                    {{--<td colspan="1" ><span class="toLeftTop2 pull-left"><input type="checkbox"> <b>Check items in Purchase Order versus Delivery Receipt</b></span></td>--}}
                                {{--</tr>--}}
                                {{--<tr>--}}
                                    {{--<td colspan="1" ><span class="toLeftTop2 pull-left"><input type="checkbox"> <b>Attach the Delivery Receipt from Supplier</b> </span></td>--}}
                                {{--</tr>--}}
                            {{--</table>--}}
                        {{--</div>--}}
                    {{--</div>--}}
...
{{--------------Acknowledgement Receipt MASTER BLADE ADMIN STAFF ONLY----------------------}}
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <table class="table-condensed centerContent" style = "overflow-x:auto; border-collapse:collapse; table-layout:fixed; width : 100%" id = "brandItemsTable3">
                                                            ...
                                                            <tr name="0">
                                                                <th colspan="1" style = "background-color: darkgrey; color : black; font-weight:bold;padding-bottom: 15px;">Quantity</th>
                                                                <th colspan="1" style = "background-color: darkgrey; color : black; font-weight:bold; padding-bottom: 15px;">Brand - Item - Description</th>
                                                                <th colspan="1" style = "background-color: darkgrey; color : black; font-weight:bold; "> <span style = " padding-top : 10px;">Warranty Period</span>
                                                            ...
                                                            <tr>
                                                                <th colspan = "5" style = "padding-left : 10px; padding-right : 20px;">
                                                                    ...
                                                                    <div class="row" style = "padding-top : 40px">
                                                                        <div class= "col-md-5">
                                                                            <span class="pull-right" style = "width: 270px; border-bottom-style :solid"></span>
                                                                        </div>
                                                                        <div class= "col-md-2"></div>
                                                                        <div class= "col-md-5">
                                                                            <span class="pull-left" style = "width: 270px; border-bottom-style :solid"></span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row" style = "">
                                                                        <div class="col-md-1"></div>
                                                            ...
                                                            <div class="box-body">
                                                                <div class="row" style="padding-top: 15px;">
                                                                    <div class="col-md-11">
                                                                        ...
                                                                        <tr>
                                                                            <td colspan="1"><span class="toLeftTop2 pull-left" style="padding-left: 260px"><input type="checkbox" class="Check_arView" name="0"> <b>Approved Requisition</b></span></td>
                                                                        </tr>
                                                                        <tr>
                                                                        ...
                                                                        <table class="table-condensed hideThisTable" hidden style = "table-layout:fixed; width : 100%; margin-top : 20px;">
                                                                            <tr>
                                                                                <td style="border: none ;">
                                                                                    <button class="btn btn-success pull-right" value="Acknowledge" >
                                                                                        Acknowledge
                                                                                    </button>
                                                                                </td>
                                                                            </tr>
    ...
    {{--<div class="modal fade" id="modal_requisition_form_view">--}}
        {{--<div class="modal-dialog modal-lg">--}}
            {{--<div class="modal-content">--}}
                {{--<div class="modal-header">--}}
                {{--<button type="button" class="close" data-dismiss="modal" aria-label="Close">--}}
                    ...
                    {{--<div class = "row" style = "padding-top : 30px;">--}}
                        {{--<div class = "col-md-12">--}}
                            {{--<table class="table-condensed" style = "overflow-x:auto; border-collapse:collapse; table-layout:fixed; width : 100%" >--}}
                                ...
                                {{--</tr>--}}
                                {{--<tr>--}}
                                    {{--<td colspan="2" style="font-weight:bold;"><span class = "pull-left toLeftTop">Date of Request:</span> </td>--}}
                                    {{--<td colspan = "2"><input type="date" class = "form-control toClear" id = "dateOfRequestAdmin_view" disabled></td>--}}
                                {{--</tr>--}}
                                {{--<tr>--}}
                                    {{--<td colspan="2" style="font-weight:bold;"><span class = "pull-left toLeftTop">Requested by:</span> </td>--}}
                                ...
                                {{--</tr>--}}
                                {{--<tr>--}}
                                    {{--<td colspan="2" style="font-weight:bold;"><span class = "pull-left toLeftTop">Date needed: </span></td>--}}
                                    {{--<td colspan = "2"><input type="date" class = "form-control toClear" id = "dateNeededRequi_view" disabled></td>--}}
                                {{--</tr>--}}
                                {{--<tr>--}}
                                    {{--<td colspan="2" style="font-weight:bold;"><span class = "pull-left toLeftTop">Approved by: </span></td>--}}
                                    {{--<td colspan = "2"><input type="text" class = "form-control toClear" id = "approvedByRequi_view" disabled></td>--}}
                                {{--</tr>--}}
                                {{--<tr>--}}
                                    {{--<td colspan="2" style="font-weight:bold;"><span class = "pull-left toLeftTop">Approval Date:</span></td>--}}
                                ...
                                {{--</tr>--}}
                                {{--<tr>--}}
                                    {{--<td colspan="2" style="font-weight:bold;"><span class = "pull-left toLeftTop"><input type="radio" name = "typeReqRequi" id = "clickNew"  disabled> New Request</span></td>--}}
                                    {{--<td colspan="2" rowspan="2"><textarea class="form-control toClear" id = "req_reason_remarks_view" rows="2" disabled></textarea></td>--}}
                                {{--</tr>--}}
                                {{--<tr>--}}
                                    {{--<td colspan="2" style="font-weight:bold;"><span class = "pull-left toLeftTop"><input type="radio" name = "typeReqRequi"  id = "clickReplacement" disabled> Replacement</span></td>--}}
                                {{--</tr>--}}
                                {{--<tr>--}}
                                    {{--<td colspan="4" style = "background-color: darkgrey; color : black; font-weight:bold; ">Supplies/Equipment/Furniture</td>--}}
                                {{--</tr>--}}
                                {{--<tr>--}}
                                    {{--<td colspan="2" style="font-weight:bold;"><span class = "pull-left toLeftTop"><input type="checkbox" value = "Office Supplies" class = "requiListview"> Office Supplies</span></td>--}}
                                    {{--<td colspan="2" style="font-weight:bold;"><span class = "pull-left toLeftTop"><input type="checkbox" value = "Shredder" class = "requiListview" > Shredder</span></td>--}}
                                {{--</tr>--}}
                                {{--<tr>--}}
                                    {{--<td colspan="2" style="font-weight:bold;"><span class = "pull-left toLeftTop"><input type="checkbox" value = "Uniform" class = "requiListview" > Uniform</span></td>--}}
                                    {{--<td colspan="2" style="font-weight:bold;"><span class = "pull-left toLeftTop"><input type="checkbox" value ="Fire Extinguisher" class = "requiListview" > Fire Extinguisher</span></td>--}}
                                {{--</tr>--}}
                                {{--<tr>--}}
                                    {{--<td colspan="2" style="font-weight:bold;"><span class = "pull-left toLeftTop"><input type="checkbox" value = "Load" class = "requiListview"> Load</span></td>--}}
                                    {{--<td colspan="2" style="font-weight:bold;"><span class = "pull-left toLeftTop"><input type="checkbox" value = "Chair" class = "requiListview" > Chair</span></td>--}}
                                {{--</tr>--}}
                                {{--<tr>--}}
                                    {{--<td colspan="2" style="font-weight:bold;"><span class = "pull-left toLeftTop"><input type="checkbox" value = "Computer" class ="requiListview" > Computer</span></td>--}}
                                    {{--<td colspan="2" style="font-weight:bold;"><span class = "pull-left toLeftTop"><input type="checkbox" value = "Filing Cabinet" class = "requiListview" > Filing Cabinet</span></td>--}}
                                {{--</tr>--}}
                                {{--<tr>--}}
                                    {{--<td colspan="2" style="font-weight:bold;"><span class = "pull-left toLeftTop"><input type="checkbox" value = "Printer" class = "requiListview" > Printer</span></td>--}}
                                    {{--<td colspan="2" style="font-weight:bold;"><span class = "pull-left toLeftTop"><input type="checkbox" value = "Table" class = "requiListview"  > Table</span></td>--}}
                                {{--</tr>--}}
                                {{--<tr>--}}
                                    {{--<td colspan="2" style="font-weight:bold;"><span class = "pull-left toLeftTop"><input type="checkbox" value = "IP Phone" class = "requiListview" > IP Phone</span></td>--}}
                                    {{--<td colspan="2" style="font-weight:bold;"><span class = "pull-left toLeftTop"><input type="checkbox" value = "Shelves" class = "requiListview" > Shelves</span></td>--}}
                                {{--</tr>--}}
                                {{--<tr>--}}
                                    {{--<td colspan="2" style="font-weight:bold;"><span class = "pull-left toLeftTop"><input type="checkbox" value = "Mobile Phone" class = "requiListview" > Mobile Phone</span></td>--}}
                                    {{--<td colspan="2" style="font-weight:bold;"><span class = "pull-left toLeftTop"><input type="checkbox" value = "Accesories" class = "requiListview" > Accesories</span></td>--}}
                                {{--</tr>--}}
                                {{--<tr>--}}
                                    {{--<td colspan="2" style="font-weight:bold;"><span class = "pull-left toLeftTop"><input type="checkbox" value = "Projector" class = "requiListview" > Projector</span></td>--}}
                                    {{--<td colspan="2" style="font-weight:bold;"><span class = "pull-left toLeftTop"><input type="checkbox" value = "Others (Please Specify)" class = "requiListview"> Others (Please Specify) :</span> </td>--}}
                                {{--</tr>--}}
                                {{--<tr>--}}
                                    {{--<td colspan="2" style="font-weight:bold;"><span class = "pull-left toLeftTop"><input type="checkbox" value = "Photocopier" class = "requiListview" > Photocopier</span></td>--}}
                                    {{--<td colspan="2" style="font-weight:bold;"><span class = "pull-left toLeftTop"><input type="checkbox" value="namecheckother1" class = "requiListview"> <input type="text" id = "otherCheck-0_view" class = "toClear" disabled></span></td>--}}
                                {{--</tr>--}}
                                {{--<tr>--}}
                                    {{--<td colspan="2" style="font-weight:bold;"><span class = "pull-left toLeftTop"><input type="checkbox" value = "ID Maker" class = "requiListview" > ID Maker</span></td>--}}
                                    {{--<td colspan="2" style="font-weight:bold;"><span class = "pull-left toLeftTop"><input type="checkbox" class ="requiListview" value = "namecheckother2"  > <input type="text"  id = "otherCheck-1_view" class = "toClear" disabled></span></td>--}}
                                {{--</tr>--}}
                                {{--<tr>--}}
                                    {{--<td colspan="2" style="font-weight:bold;"><span class = "pull-left toLeftTop"><input type="checkbox" class = "requiListview" > Scanner</span></td>--}}
                                    {{--<td colspan="2" style="font-weight:bold;"><span class = "pull-left toLeftTop"><input type="checkbox" class = "requiListview" value = "namecheckother3" > <input type="text"  id = "otherCheck-2_view" class = "toClear" disabled></span></td>--}}
                                {{--</tr>--}}
                            {{--</table>--}}
                            {{--<table class="table-condensed" style = "overflow-x:auto; border-collapse:collapse; table-layout:fixed; width : 100%" >--}}
                ...
                {{--<div class="modal-footer">--}}
                    {{--<button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>--}}
                    {{--<span class= "pull-right" ><button type="button" class="btn btn-success" id = "approveRequestReq">Approve Request</button></span>--}}
                    {{--<span class= "pull-right" style = "padding-right : 10px;" ><button type="button" class="btn btn-danger" id = "rejectRequestReq">Deny Request</button></span>--}}
                {{--</div>--}}
            {{--</div>--}}
            {{--<!-- /.modal-content -->--}}
        {{--</div>--}}
    ...
    <div class="modal modal-info fade" id="modal-loading-accredited-supplier">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p style="text-align: center">Please wait while the submitting the record.  <img src="{{ asset('dist/img/loading.gif') }}" style="width: 5%;"></p>
                    <div class = "row" style = "padding-top : 10px;">
                        <div class = "col-md-2"></div>
                        <div class = "col-md-8">
    ...
    <div class="modal fade" id="modal_pass_to_manage_supplier">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-success pull-right" id = "submitNowComparisan" >Send <span id = "loadingSpanSenRepSupManage" hidden><img src="{{ asset('dist/img/loading.gif') }}" style="width: 7%; margin-left : 10px;"></span></button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
...
@push('jscript')
    ...
    <script src="{{ asset('jscript/admin-data-management.js?n='.$javs) }}"></script>
@endpush