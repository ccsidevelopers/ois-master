                        ...
                        <div class="panel-body">
                            <div id="smartwizard" style="padding-left : 5%; padding-right: 5%">
                                <ul class="nav">
                                    ...
                                    @if(Auth::user()->id == '1248' || Auth::user()->id == '1253 ' ||Auth::user()->id == '1254' ||Auth::user()->id == '1255')

                                    @elseif(Auth::user()->id == '1204' ||Auth::user()->id == '1184')
                                        <li>
                                                ...
                                                <div class="box box-primary">
                                                    ...
                                                    <div class="box-body">
                                                        ...
                                                        <div class = "row" style="padding-top: 20px;">
                                                            @if(Auth::user()->id == '1248' || Auth::user()->id == '1253 ' ||Auth::user()->id == '1254' ||Auth::user()->id == '1255')
                                                                <input type="text" id="checkIfQualfon" value={{$validation_qualfon}} hidden>
                                                                @endif
                                                        ...
                                                        @if(Auth::user()->id == '1248' || Auth::user()->id == '1253 ' ||Auth::user()->id == '1254' ||Auth::user()->id == '1255')
                                                            ...
                                                            <div class = "row">
                                                                ...
                                                                <div class="form-group col-md-3">
                                                                    <label>TIN No.:<small style="color : red;">*Required: 12-digit</small></label></label>
                                                                    <input type="number" class="form-control save_benefits toRed" id="acct_tin" name="acc_tin">
                                                                </div>

                                                                <div class = "form-group col-md-3">
                                                                    <label>Philhealth: <small style="color : red;">*Required: 12-digit</small></label></label>
                                                                    <input type="text" class = "form-control save_benefits toRed"  id = "acct_philhealth" name = "acct_philhealth">
                                                                </div>
                                                                <div class = "form-group col-md-3">
                                                                    <label>Pagibig: <small style="color : red;">*Required: 12-digit</small></label></label>
