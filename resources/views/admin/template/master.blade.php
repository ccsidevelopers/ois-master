<!DOCTYPE html>
<html>
@include('admin.template.includes.headerplugins')
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                {{--<div class="nav-tabs-custom">--}}
                    {{--<ul class="nav nav-tabs">--}}
                        {{--<li class="active"><a href="#tab_1-bi-view" data-toggle="tab">View</a></li>--}}
                        {{--<li><a href="#tab_2-bi-view" data-toggle="tab">Account to Users</a></li>--}}
                    {{--</ul>--}}
                    {{--<div class="tab-content">--}}
                        {{--<div class="tab-pane active" id="tab_1-bi-view">--}}
                        {{--</div>--}}
                        {{--<div class="tab-pane" id="tab_2-bi-view">--}}
                            {{--<div class="row">--}}
                                {{--<div class="col-md-12">--}}
                                    {{--<div class="col-md-6">--}}
                                        {{--<div class="form-group">--}}
                                            ...
                                            {{--<select name="" id="" class="select2">--}}
                                                {{--<option value=""></option>--}}
                                            {{--</select>--}}
                                            {{--<label for="selectSite">Select User:</label>--}}
                                            {{--<span id="selectSiteSpan"></span>--}}
                                        {{--</div>--}}
                                    {{--</div>--}}
                                {{--</div>--}}
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    {{--<div class="form-group">--}}
                                                    {{--<label>Work Start:<small style="color: red">(Required Field)</small></label>--}}
                                                    {{--<div class="input-group">--}}
                                                    {{--<input type="text" class="form-control timepicker" readonly id="attendance_work_start">--}}
                                                    ...
                                                    {{--<div class="bootstrap-timepicker">--}}
                                                    {{--<div class="form-group">--}}
                                                    {{--<label>Work End:<small style="color: red">(Required Field)</small></label>--}}
                                                    {{--<div class="input-group">--}}
                                                    {{--<input type="text" class="form-control timepicker" readonly id="attendance_work_end">--}}
                                                    {{--<div class="input-group-addon">--}}
                                                    {{--<i class="fa fa-clock-o"></i>--}}
                                                    {{--</div>--}}
                                                    {{--</div>--}}
...
<div class="wrapper">
    ...
    @include('admin.template.includes.header')
    @include('admin.template.includes.leftsidebar')

    @yield('content')

    @include('admin.template.includes.footer')
    @include('admin.template.includes.rightsidebar')

</div>
@include('admin.template.includes.footerplugins')
@stack('jscript')
</body>
</html>
