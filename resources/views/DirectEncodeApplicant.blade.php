                        ...
                        <div class="panel-body">
                            <div id="smartwizard" style="padding-left : 5%; padding-right: 5%">
                                <ul class="nav">
                                    ...
                                    {{--@if(preg_match('/(qualfon)/',Request::path()))--}}

                                    @if(preg_match('/(sitel)/',Request::path()) || preg_match('/(alorica)/',Request::path()) || preg_match('/(qualfon)/',Request::path()) || preg_match('/(teleperformance)/',Request::path()) || preg_match('/(concentrix-main)/',Request::path()) || preg_match('/(ccsi)/',Request::path()) || preg_match('/(tdcx)/',Request::path()) || preg_match('/(ubiquity)/',Request::path()) || preg_match('/(personal)/',Request::path())|| preg_match('/(247)/',Request::path()))
                                        <li>
                                    ...
                                    {{--@if($user == '1248' || $user == '1253' ||$user == '1254' ||$user == '1255' || $user == '1000012')--}}

                                    {{--@elseif($user == '384' ||$user == '1184')--}}
                                        {{--<li>--}}
                                            {{--<a class="nav-link" href="#step-6">--}}
                                                {{--V. AUTHORIZATION/CONFIRMATION OF INFORMATION--}}
                                            {{--</a>--}}
                                                ...
                                                <div class="box box-primary">
                                                    ...
                                                    <div class="box-body">
                                                        ...
                                                        <div class = "row" style="padding-top: 20px;">
                                                                <input type="text" id="checkIfQualfon" value={{$check_qualfon}} hidden>
                                                                <input type="text" id="idToSite" value={{$user}} hidden>
...
{{--                                                        @if($user == '1248' || $user == '1253' ||$user == '1254' ||$user == '1255' || $user == '1000012')--}}
                                                        ...
                                                        {{--@elseif($user == '384' ||$user == '1184')--}}
                                                        @elseif(preg_match('/(sitel)/',Request::path()))
                                                            {{--sitel 384--}}
                                                            <div class = "row">
                                                                <div class = "form-group col-md-3">
                                        ...
                                        <div class="row" style="padding-top : 40px;">
                                            ...
                                            <div class="col-md-10">
                                                <div class="box box-primary">
                                                   ...
                                                   if(preg_match('/(sitel)/',Request::path()))
                                                    {
                                                       $checkifsitel = '<small style="color : red">*Required Field*</small>';
                                                       $sitelboolean = true;
                                                    }
                                                    else
                                                    {
                                                        $checkifsitel = '<small style="color : orange">*Optional*</small>';
                                                        $sitelboolean = false;
                                                    }
                                                    @endphp
                                                    <div class="box-body">
                                                        <div class = "row" style="padding-top : 20px;">
                                                            <div class = "form-group col-md-12">
                                                                <h4>Professional References: {!! $checkifsitel !!} <button class="btn btn-xs btn-success" id="btnAddCharacter"><i class="fa fa-plus"></i></button></h4>
                                                                <input type="hidden" id="checkifsitel" value="{{$sitelboolean == true ? '1' : '0'}}">
                                                                <table class="display table-hover responsive"  style="width : 100%" id="characDatatable">
                                                                    <thead>
                                                                        <tr>
                                                                            <th>Name {!! $checkifsitel !!}</th>
                                                                            <th>Position Employment {!! $checkifsitel !!}</th>
                                                                            <th>Company Address{!! $checkifsitel !!}</th>
                                                                            <th>Email Address {!! $checkifsitel !!}</th>
                                                                            <th>Telephone No./Mobile No. {!! $checkifsitel !!}</th>
                                                                            <th></th>
                                                                        </tr>
                                                                    </thead>
                                    ...
                                    <div id="step-5" class="tab-pane" role="tabpanel">
                                        ...
                                        {{--@if(preg_match('/(qualfon)/',Request::path()))--}}
                                            ...
                                            {{--</div>--}}
{{--                                        @elseif($user == '384' ||$user == '1184')--}}
                                        @if(preg_match('/(sitel)/',Request::path()) || preg_match('/(alorica)/',Request::path()) || preg_match('/(qualfon)/',Request::path())  || preg_match('/(teleperformance)/',Request::path()) || preg_match('/(ccsi)/',Request::path()) || preg_match('/(tdcx)/',Request::path()) || preg_match('/(ubiquity)/',Request::path()) || preg_match('/(personal-collection)/',Request::path()) || preg_match('/(concentrix-main)/',Request::path())|| preg_match('/(247)/',Request::path()))
                                            <div class="row" style="padding-top : 20px">
                                                <div class="col-md-12">
                                                    <button class="btn btn-primary btn-md pull-right btnnextTab" style="margin-left : 10px">Next <i class="glyphicon glyphicon-triangle-right"></i> </button>
                                                    <button class="btn btn-default btn-md pull-right btnpreviousTab"><i class="glyphicon glyphicon-triangle-left"></i> Previous</button>
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div class="form-group">
                                                                                <div class="col-md-6">
                                                                                    ...
                                                                                    @for($i =1; $i <= 10; $i++)
                                                                                        <center style="font-size: 1.2em">
                                                                                            {{$i}}. <b><u><span class="auth_letter_change" classification="company_name{{$i}}" hidden></span></u></b>
                                                                                            <textarea class="auth_letter_change_input" classification="company_name{{$i}}" cols="40" rows="1" style="resize: none; border-width: 0 0 2px;outline: 0;border-color: blue; margin-bottom: -8px;" placeholder="(Optional Field)"></textarea>
                                                                                        </center>
                                                                                        <br>
                                                                                    @endfor
                                                                                </div>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="col-md-6">
                                                                                    ...
                                                                                    @for($j =1; $j <= 10; $j++)
                                                                                        <center style="font-size: 1.2em">
                                                                                            <b><u><span class="auth_letter_change" classification="contact_info{{$j}}" hidden></span></u></b>
                                                                                            @if($j == 10)
                                                                                                <textarea class="auth_letter_change_input" classification="contact_info{{$j}}" cols="49" rows="1" style="resize: none; border-width: 0 0 2px;outline: 0;border-color: blue; margin-bottom: -8px;" placeholder="(Optional Field)"></textarea>
                                                                                            @else
                                                                                                <textarea class="auth_letter_change_input" classification="contact_info{{$j}}" cols="50" rows="1" style="resize: none; border-width: 0 0 2px;outline: 0;border-color: blue; margin-bottom: -8px;" placeholder="(Optional Field)"></textarea>
                                                                                            @endif
                                                                                        </center>
                                                                                        <br>
                                                                                    @endfor
                                                                    ...
                                                                    <div class="row pdfShow" hidden>
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <table style="table-layout: fixed">
                                                                                ...
                                                                                @for($k =1; $k <= 10; $k++)
                                                                                    <tr>
                                                                                        <td>{{$k}}. <b><u><span class="auth_letter_change" classification="company_name{{$k}}"></span></u></b></td>
                                                                                        <td><b><u><span class="auth_letter_change" classification="contact_info{{$k}}"></span></u></b></td>
                                                                                        <td></td>
                                                                                    </tr>
                                                                                @endfor
                                                                            </table>
                                    ...
                                    @elseif(preg_match('/(alorica)/',Request::path()))
                                        <div id="step-6" class="tab-pane" role="tabpanel">
                                            <div class="row">
                                                <div class="col-md-2"></div>
                                                <div class="col-md-8">
                                                            ...
                                                            <div class="box-body" id="auth_letter_body_employment">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <span class="pull-right" style="font-size: 1.2em; float: right;"><u><b>{{date('Y-m-d')}}</b></u></span>
                                                                        <br>
                                                                        <br>
                                    ...
                                    @elseif(preg_match('/(teleperformance)/',Request::path()))
                                        <div id="step-6" class="tab-pane" role="tabpanel">
                                            <div class="row">
                                                <div class="col-md-2"></div>
                                                <div class="col-md-8">
                                    ...
                                    @elseif(preg_match('/(ccsi)/',Request::path()))
                                        <div id="step-6" class="tab-pane" role="tabpanel">
                                            <div class="row">
                                                <div class="col-md-2"></div>
                                                <div class="col-md-8">
                                        ...
                                        @elseif(preg_match('/(247)/',Request::path()))
                                        <div id="step-6" class="tab-pane" role="tabpanel">
                                            <div class="row">
                                                <div class="col-md-2"></div>
                                                <div class="col-md-8">
                                                    <div class="row">
                                                        <div class="box">
                                                            ...
                                                            <div class="box-body" id="auth_letter_body_employment">
                                                                <div class="col-md-12">
                                                                    <div class="row">
                                                                        <img src="../dist/img/intouch.png" class="pull-left logoPDF" logo-type="false" style="max-width: 155px;">
                                                                        <img src="dist/img/intouch.png" class="pull-left logoPDF" logo-type="true" hidden style="max-width: 155px; float: left">
                                                                    </div>
                                                                    <div class="row">
                                                                        <center><h4><label><u>Self Declaration/Autorization</u></label></h4></center>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <center>
                                                                            <p style="font-size: 1.2em">I am currently seeking employment with 24/7 Intouch. As part of 24/7 Intouch's procedure of processing my application an investigative
                                                                                report about my background may be made. I therefore authorize 24/7 Intouch to investigate information concerning my education, employment and all other aspects
                                                                                of my background relevant to my proposed employment. I also certify that all information supplied in conjunction with my application are true and correct in all aspects and I have not
                                                                                willfully suppressed any fact. Your assistance in providing 24/7 Intouch the information requested will be highly appreciated as it would help facilitate the processing of my application.
                                                                            </p>
                                        ...
                                        @elseif(preg_match('/(ubiquity)/',Request::path()))
                                        <div id="step-6" class="tab-pane" role="tabpanel">
                                            <div class="row">
                                                <div class="col-md-2"></div>
                                                <div class="col-md-8">
                                                    <div class="row">
                                                        <div class="box">
                                                            ...
                                                            <div class="box-body" id="auth_letter_body_employment">
                                                                <div class="col-md-12">
                                                                    <div class="row">
                                                                        <img src="../dist/img/ubiquity_logo.png" class="pull-left logoPDF" logo-type="false" style="max-width: 155px;">
                                                                        <img src="dist/img/ubiquity_logo.png" class="pull-left logoPDF" logo-type="true" hidden style="max-width: 155px; float: left">
                                                                    </div>
                                                                    <div class="row">
                                                                        <center><h4><label><u>Self Declaration/Autorization</u></label></h4></center>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <center>
                                                                            <p style="font-size: 1.2em">I am currently seeking employment with Ubiquity. As part of Ubiquity's procedure of processing my application an investigative
                                                                                report about my background may be made. I therefore authorize Ubiquity to investigate information concerning my education, employment and all other aspects
                                                                                of my background relevant to my proposed employment. I also certify that all information supplied in conjunction with my application are true and correct in all aspects and I have not
                                                                                willfully suppressed any fact. Your assistance in providing Ubiquity the information requested will be highly appreciated as it would help facilitate the processing of my application.
                                                                            </p>
                                        ...
                                        @elseif(preg_match('/(personal)/',Request::path()))
                                        <div id="step-6" class="tab-pane" role="tabpanel">
                                            <div class="row">
                                                <div class="col-md-2"></div>
                                                <div class="col-md-8">
                                                    <div class="row">
                                                        <div class="box">
                                                            ...
                                                            <div class="box-body" id="auth_letter_body_employment">
                                                                <div class="col-md-12">
                                                                    <div class="row">
                                                                        <img src="../dist/img/PC.png" class="pull-left logoPDF" logo-type="false" style="max-width: 155px;">
                                                                        <img src="dist/img/PC.png" class="pull-left logoPDF" logo-type="true" hidden style="max-width: 155px; float: left">
                                                                    </div>
                                                                    <div class="row">
                                                                        <center><h4><label><u>Self Declaration/Autorization</u></label></h4></center>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <center>
                                                                            <p style="font-size: 1.2em">I am currently seeking employment with Personal Collection. As part of Personal Collection's procedure of processing my application an investigative
                                                                                report about my background may be made. I therefore authorize Personal Collection to investigate information concerning my education, employment and all other aspects
                                                                                of my background relevant to my proposed employment. I also certify that all information supplied in conjunction with my application are true and correct in all aspects and I have not
                                                                                willfully suppressed any fact. Your assistance in providing Personal Collection the information requested will be highly appreciated as it would help facilitate the processing of my application.
                                                                            </p>
                                         ...
                                         @elseif(preg_match('/(concentrix-main)/',Request::path()))
                                        <div id="step-6" class="tab-pane" role="tabpanel">
                                            <div class="row">
                                                <div class="col-md-2"></div>
                                                <div class="col-md-8">
                                                        ...
                                                        <div class="box">
                                                            ...
                                                            <div class="box-body" id="auth_letter_body_employment">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <div class="row">
                                                                        <center>
                                                                            <p style="font-size: 1.2em">I am currently seeking employment with Concentrix. As part of Concentrix's procedure of processing my application an investigative
                                                                                report about my background may be made. I therefore authorize Concentrix's to investigate information concerning my education, employment and all other aspects
                                                                                of my background relevant to my proposed employment. I also certify that all information supplied in conjunction with my application are true and correct in all aspects and I have not
                                                                                willfully suppressed any fact. Your assistance in providing Concentrix's the information requested will be highly appreciated as it would help facilitate the processing of my application.
                                                                            </p>
                                    ...
                                    @elseif(preg_match('/(tdcx)/',Request::path()))
                                        <div id="step-6" class="tab-pane" role="tabpanel">
                                            <div class="row">
                                                <div class="col-md-2"></div>
                                                <div class="col-md-8">
                                                    <div class="row">
                                                        <div class="box">
                                                            <div class="box-body" id="auth_letter_body_employment">
                                                                <div class="col-md-12 ">
                                                                    <div class="row">
                                                                        {{--<img src="../dist/img/TDCX.jpg" class="pull-left logoPDF" logo-type="false">--}}
                                                                        {{--<img src="dist/img/TDCX.jpg" class="pull-left logoPDF" logo-type="true" hidden style="float: left">--}}
                                                                        {{--<h2 class="pull-right" style="float: right"><label>S-1</label></h2>--}}
                                                                    </div>
                                                                    <div class="row">
                                                                        <center><h4><label>DECLARATION</label></h4></center>
...
{{--        @if($user == '1248' || $user == '1253' ||$user == '1254' ||$user == '1255' || $user == '1000012')--}}
        ...
        <div class="modal fade" id="modal-click-here" data-backdrop="static">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title"><center>  <img src="{{ asset('dist/img/qualfonLogo.png')}}" style="width: 25%;"> </center></h4>
                        </div>
                        <div class="modal-body">
                            <div class="row">
        ...
        <div class="modal fade" id="modal-click-here" data-backdrop="static">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title"><center>  <img src="{{ asset('dist/img/Aloricalogo.png')}}" style="max-width: 155px; "> </center></h4>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-12"  style="overflow: auto; height: 500px;">
        ...
        <div class="modal fade" id="modal-click-here" data-backdrop="static">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title"><center>  <img src="{{ asset('dist/img/Teleperformance_logo.png')}}" style="width: 25%; height: 25%"> </center></h4>
                    </div>
                    <div class="modal-body">
                        <div class="row">
        ...
        <div class="modal fade" id="modal-click-here" data-backdrop="static">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title"><center>  <img src="{{ asset('dist/img/ccsi-icon-transparent.png')}}" style="width: 25%; height: 25%"> </center></h4>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-12"  style="overflow: auto; height: 300px">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <h4><b>ACKNOWLEDGEMENT AND EXPRESS CONSENT TO THE NOTICE</b></h4>
                                    <h4>
                                        I have read this Notice and I understand its contents and acknowledge the application of its terms, including those regarding the collection, processing and use of my Personal Data, including Sensitive Personal Data, by CCSI, and the international transfer of my Personal Data to jurisdictions where data protection laws may not provide an equivalent level of protection.
                                    </h4>
                                    <center><input type="checkbox" id="check_agreement"> <label for="check_agreement" style="font-weight: 400"> <h4>I agree to the terms and conditions.</h4> </label></center>
                                </div>
                            </div>
        ...
        <div class="modal fade" id="modal-click-here" data-backdrop="static">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title"><center>  <img src="{{ asset('dist/img/intouch.png')}}" style="width: 25%; height: 25%"> </center></h4>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-12"  style="overflow: auto; height: 300px">
                                    <div class="box box-danger">
                                        <div class="box-body">
                                            <div class="row">
                                                ...
                                                <h4>
                                                    I hereby know and understand that as part of application process, I shall be subjected to a
                                                    BACKGROUND CHECK commissioned by 24/7 Intouch. Hence, I hereby authorize 24/7 Intouch and or its authorized
                                                    representative to confirm and verify information/s stated above prior to employment, including matters
                                                    of conduct, behaviour, ability, reputation, education, family, and as well as my criminal, financial and
                                                    credit standing. I also authorize and request each person and firm referred in my Application Form to
                                                    give such information.
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <h4><b>ACKNOWLEDGEMENT AND EXPRESS CONSENT TO THE NOTICE</b></h4>
                                    <h4>
                                        I have read this Notice and I understand its contents and acknowledge the application of its terms, including those regarding the collection, processing and use of my Personal Data, including Sensitive Personal Data, by 24/7 Intouch, and the international transfer of my Personal Data to jurisdictions where data protection laws may not provide an equivalent level of protection.
                                    </h4>
                                    <center><input type="checkbox" id="check_agreement"> <label for="check_agreement" style="font-weight: 400"> <h4>I agree to the terms and conditions.</h4> </label></center>
                                </div>
                            </div>
        ...
        <div class="modal fade" id="modal-click-here" data-backdrop="static">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title"><center>  <img src="{{ asset('dist/img/TDCX.jpg')}}" style="width: 25%; height: 25%"> </center></h4>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-12"  style="overflow: auto; height: 300px">
       ...
       @elseif(preg_match('/(ubiquity)/',Request::path()))
        <div class="modal fade" id="modal-click-here" data-backdrop="static">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h2 class="modal-title"><center><img src="{{ asset('dist/img/ubiquity_logo.png')}}" class="pull-center" style="width: 30%; height: 25%"></center></h2>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                           <p>
                                                ...
                                                <h4>
                                                    I hereby know and understand that as part of application process, I shall be subjected to a
                                                    BACKGROUND CHECK commissioned by CCSI. Hence, I hereby authorize Ubiquity and or its authorized
                                                    representative to confirm and verify information/s stated above prior to employment, including matters
                                                    of conduct, behaviour, ability, reputation, education, family, and as well as my criminal, financial and
                                                    credit standing. I also authorize and request each person and firm referred in my Application Form to
                                                    give such information.
        ...
        </div>@elseif(preg_match('/(personal)/',Request::path()))
        <div class="modal fade" id="modal-click-here" data-backdrop="static">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h2 class="modal-title"><center><img src="{{ asset('dist/img/PC.png')}}" class="pull-center" style="width: 30%; height: 25%"></center></h2>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                           <p>
                                                ...
                                                <h4>
                                                    I hereby know and understand that as part of application process, I shall be subjected to a
                                                    BACKGROUND CHECK commissioned by CCSI. Hence, I hereby authorize Personal Collection and or its authorized
                                                    representative to confirm and verify information/s stated above prior to employment, including matters
                                                    of conduct, behaviour, ability, reputation, education, family, and as well as my criminal, financial and
                                                    credit standing. I also authorize and request each person and firm referred in my Application Form to
                                                    give such information.
