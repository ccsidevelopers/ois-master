...
<br>
<p>Birthday Notification</p>

<ul class="list-group">
    @for($ctr = 0; $ctr<$count; $ctr++ )
        <li class="list-group-item">Client Name: {{ $client_name[$ctr] }}</li>
        <li class="list-group-item">Birth Day: {{  $birthdate[$ctr] }}</li>
        <li class="list-group-item">Contract Number: {{  $contact_num[$ctr] }}</li>
        <li class="list-group-item">Email Address: {{  $email_add[$ctr] }}</li>
        <li class="list-group-item">Client Position: {{  $client_position[$ctr] }}</li>
        <li class="list-group-item">Gift Type: {{  $gift_type[$ctr] }}</li>
        <li class="list-group-item">Bank Name: {{  $bank_name[$ctr] }}</li>
