<head>
    ...
    {{--TAGSINPUT-LATEST--}}
    <link href="{{ asset('plugins/bootstrap-tagsinput-latest/src/bootstrap-tagsinput.css') }}" rel="stylesheet" type="text/css">
    
    <link href="{{ asset('plugins/jquery-smartwizard-master/dist/css/smart_wizard_arrows.css') }}" rel="stylesheet" type="text/css">
