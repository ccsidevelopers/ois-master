                ...
                <div class="main-form">
                    ...
                    <div class="row pt-4 border-bottom border-3 border-danger py-3">
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            <div id="upload_append_id" class="col-md-4 py-3 upload_append">
                                <label id="expenses_input_files_label_default" class="file_upload_btn" for="inputLoanAttachmentOfId" class="pb-2">ID with Signature</label>
                                <div class="d-flex align-items-center">
                                <input id="file" type="file" class="form-control form-control expenses_class expenses_files_upload" name="#expenses_input_files_label_default">
                                {{-- temporary comment out add new button --}}
                                <span class="btn btn-secondary m-2 file_upload_add_more"><i class="bi bi-file-earmark-plus"></i></span>
                                </div>
                            </div>
                        </div>
                    </div>
