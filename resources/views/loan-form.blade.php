                ...
                <div class="main-form">
                    <div class="typeOfLoan row border-bottom border-3 border-primary py-3">
                        ...
                        <div class="form-group col-md-2 py-2">
                            <div class="my-2">
                                <input type="checkbox" class="text-uppercase TOLselect" id="inputLoanMotorcycleLoan" name="TOLselector[]" value="Motorcycle loan">
                                <label for="inputLoanMotorcycleLoan">Motorcycle Loan</label>
                            </div>
                            <div class="my-2">
                                <input type="checkbox" class=" text-uppercase TOLselect" id="inputLoanAutoLoan" name="TOLselector[]" value="Auto loan">
                                <label for="inputLoanAutoLoan">Auto loan</label>
                            </div>
                        </div>
                        <div class="form-group col-md-4 py-2">
                            <div class="my-2">
                                <input type="checkbox" class=" text-uppercase TOLselect" id="inputLoanPersonalLoan" name="TOLselector[]" value="Personal loan">
                                <label for="inputLoanPersonalLoan">Personal / Salary Loan</label>
                            </div>
                            <div class="my-2">
                                <input type="checkbox" class=" text-uppercase TOLselect" id="inputLoanHomeLoan" name="TOLselector[]" value="Home loan">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-3 d-flex flex-column">
                                    <div class="my-1">
                                        <input type="checkbox" class="text-uppercase SOIselect" id="inputLoanIncomeEmployment" name="SOIselector[]" value="Employment">
                                        <label for="inputLoanIncomeEmployment">Employment</label>
                                    </div>
                                    <div class="my-1">
                                        <input type="checkbox" class="text-uppercase SOIselect" id="inputLoanIncomeBusiness" name="SOIselector[]" value="Business">
                                        <label for="inputLoanIncomeBusiness">Business</label>
                                    </div>
                                </div>
                                <div class="col-md-9 d-flex flex-column">
                                    <div class="my-1">
                                        <input type="checkbox" class="text-uppercase SOIselect" id="inputLoanIncomePension" name="SOIselector[]" value="Pension">
                                        <label for="inputLoanIncomePension">Pension</label>
                                    </div>
                                    <div class="my-1">
                                        <input type="checkbox" class="text-uppercase SOIselect" id="inputLoanIncomeOthers" name="SOIselector[]" value="Others">
