...
<p class="greet">Account Name: <b>{{$account_name}}</b></p>
<p class="greet">Endorsed By: <b>{{$poc_name}}</b></p>
<p class="greet">From: <b>{{$bi_site_name}}</b></p>
<p class="greet">Date/Time Occured: <b>{{$date_time}}</b></p>
<br>
