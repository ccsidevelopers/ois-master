...
<br>
<p><b>Endorsement Details</b></p>

<p>Endorsed Date/Time : <b>{{ $date_time  }}</b></p>
<p>Account Name : <b>{{ $accnt_name  }}</b></p>
<p>Account Address : <b>{{ $address . ', ' . $muni_name  }}</b></p>
<p>Name of Requestor : <b>{{ $req_name  }}</b></p>
<p>Type of Loan : <b>{{ $tor  }}</b></p>
<p>Type of Request : <b>{{ $type_of_req  }}</b></p>
<p>Amount Paid : PHP <b>{{ $amount  }}</b></p>
<p>Transaction ID : <b>{{ $transaction_id_paypal  }}</b></p><br>
<p></p>
