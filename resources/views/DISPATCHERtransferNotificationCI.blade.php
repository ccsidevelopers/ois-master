...
<br>
<p>Transferred by Dispatcher</p>
<ul class="list-group">
    <li class="list-group-item">Transferred by: {{ $dispa_name }}</li>
    <li class="list-group-item">From C.I: {{ $from_ci_name }}</li>
    <li class="list-group-item">To C.I: {{ $to_ci_name }}</li>
