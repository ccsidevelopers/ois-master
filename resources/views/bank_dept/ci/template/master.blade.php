...
@include('bank_dept.ci.template.includes.headerplugins')
...
<div class="wrapper">
    ...
    <div class="modal modal-warning fade" id="modal-update-location">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <center> <p id="update_text">Please wait.. <img width="10%" src="{{asset('dist/img/loading.gif')}}"> </p></center>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default pull-right" data-dismiss="modal">Close</button>
                </div>
    ...
    <div class="modal fade" id="modal-upload-selfie-daily">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            ...
                                            <div class="row" style="padding-top: 14px;">
                                                <div class="col-md-12">
                                                    ...
                                                    <table class="table-condensed centerContent" id="acknowledge-checker" style = "overflow-x:auto; border-collapse:collapse; table-layout:fixed; width : 100%; margin-top : 30px;>
                                                     <tr>
                                                            <th colspan="1" ><th  style = "background-color: darkgrey; color : black; text-align: center ">For Administration Department - Attach and secure the following documents: </th>
                                                    </tr>
                                                    <tr>
    ...
    @include('bank_dept.ci.template.includes.header')

    @stack('leftsidebar')

    @yield('content')

    @include('bank_dept.ci.template.includes.footer')
    @include('bank_dept.ci.template.includes.rightsidebar')

</div>
@include('bank_dept.ci.template.includes.footerplugins')
