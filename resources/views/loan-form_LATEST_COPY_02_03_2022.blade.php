                ...
                <div class="main-form">
                    ...
                    <div class="row pt-4">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control form-control-sm text-uppercase" id="inputLoanWorkEmailAddress">
                        </div>
                        <div class="form-group col-md-3">
                            <label for="inputLoanWorkLandlineNumber">Work Landline Number</label>
                            <input type="text" class="form-control form-control-sm text-uppercase" id="inputLoanWorkLandlineNumber">
                        </div>
                    </div>
                    <div class="row pt-4 border-bottom border-primary py-3">
                        <h5>Work Address</h5>
                        <div class="form-group col-md-6">
                    ...
                    <div class="row pt-4">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="">
                                <input type="checkbox" class="text-uppercase chb" id="inputLoanCitizenshipFilipino" name="inputLoanCitizenshipFilipino" value="Motorcycle loan">
                                <label for="inputLoanCitizenshipFilipino">Filipino</label>
                            </div>
                            <div class="">
                                <input type="checkbox" class="text-uppercase chb" id="inputLoanCitizenshipOthers" name="inputLoanCitizenshipOthers" value="Auto loan">
                                <label for="inputLoanCitizenshipOthers">Others</label>
                                <input type="text" class="text-uppercase w-50" id="inputLoanCitizenshipOthers" placeholder="Optional" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="row pt-4">
                    ...
                    <div class="row pt-4 border-bottom border-primary py-4">
                    ...
                    <div class="row pt-4">
                        <div class="form-group col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-3 d-flex flex-column">
                                    <div class="my-1">
                                        <input type="checkbox" class="text-uppercase chb" id="inputLoanIncomeEmployment" name="inputLoanIncomeEmployment" value="Motorcycle loan">
                                        <label for="inputLoanIncomeEmployment">Employment</label>
                                    </div>
                                    <div class="my-1">
                                        <input type="checkbox" class="text-uppercase chb" id="inputLoanIncomeBusiness" name="inputLoanIncomeBusiness" value="Motorcycle loan">
                                        <label for="inputLoanIncomeBusiness">Business</label>
                                    </div>
                                </div>
                                <div class="col-md-9 d-flex flex-column">
                                    <div class="my-1">
                                        <input type="checkbox" class="text-uppercase chb" id="inputLoanIncomePension" name="inputLoanIncomePension" value="Motorcycle loan">
                                        <label for="inputLoanIncomePension">Pension</label>
                                    </div>
                                    <div class="my-1">
                                        <input type="checkbox" class="text-uppercase chb" id="inputLoanIncomeOthers" name="inputLoanIncomeOthers" value="Auto loan">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-3 d-flex flex-column">
                                    <div class="my-1">
                                        <input type="checkbox" class="text-uppercase chb" id="inputLoanStatusEmployed" name="inputLoanStatusEmployed" value="Motorcycle loan">
                                        <label for="inputLoanStatusEmployed">Employed</label>
                                    </div>
                                    <div class="my-1">
                                        <input type="checkbox" class="text-uppercase chb" id="inputLoanStatusSelfEmployed" name="inputLoanStatusSelfEmployed" value="Motorcycle loan">
                                        <label for="inputLoanStatusSelfEmployed">Self-Employed</label>
                                    </div>
                                </div>
                                <div class="col-md-9 d-flex flex-column">
                                    <div class="my-1">
                                        <input type="checkbox" class="text-uppercase chb" id="inputLoanStatusRetired" name="inputLoanStatusRetired" value="Motorcycle loan">
                                        <label for="inputLoanStatusRetired">Retired</label>
                                    </div>
                                    <div class="my-1">
                                        <input type="checkbox" class="text-uppercase chb" id="inputLoanStatusOthers" name="inputLoanStatusOthers" value="Auto loan">
                    ...
                    <div class="row pt-4">
                        ...
                        <div class="row d-flex">
                            ...
                            <div class="col-md-2 d-flex flex-column">
                                <div class="my-1">
                                    <input type="checkbox" class="text-uppercase chb" id="inputLoanEmployedPrivateSector" name="inputLoanEmployedPrivateSector" value="Private Sector">
                                    <label for="inputLoanEmployedPrivateSector">Private Sector</label>
                                </div>
                                <div class="my-1">
                                    <input type="checkbox" class="text-uppercase chb" id="inputLoanEmployedBSP" name="inputLoanEmployedBSP" value="BSP">
                                    <label for="inputLoanEmployedBSP">BSP</label>
                                </div>
                            </div>
                            <div class="col-md-2 d-flex flex-column">
                                <div class="my-1">
                                    <input type="checkbox" class="text-uppercase chb" id="inputLoanEmployedGovernment" name="inputLoanEmployedGovernment" value="Government">
                                    <label for="inputLoanEmployedGovernment">Government</label>
                                </div>
                                <div class="my-1">
                                    <input type="checkbox" class="text-uppercase chb" id="inputLoanEmployedNGO" name="inputLoanEmployedNGO" value="NGO">
                            ...
                            <div class="col-md-2 d-flex flex-column">
                                <div class="my-1">
                                    <input type="checkbox" class="text-uppercase chb" id="inputLoanSESProprietorship" name="inputLoanSESProprietorship" value="Single Proprietorship">
                                    <label for="inputLoanSESProprietorship">Single Proprietorship</label>
                                </div>
                                <div class="my-1">
                                    <input type="checkbox" class="text-uppercase chb" id="inputLoanSEPartnership" name="inputLoanSEPartnership" value="Partnership">
                                    <label for="inputLoanSEPartnership">Partnership</label>
                                </div>
                            </div>
                            <div class="col-md-2 d-flex flex-column">
                                <div class="my-1">
                                    <input type="checkbox" class="text-uppercase chb" id="inputLoanSECorporation" name="inputLoanSECorporation" value="Corporation">
                                    <label for="inputLoanSECorporation">Corporation</label>
                                </div>
                                <div class="my-1">
                                    <input type="checkbox" class="text-uppercase chb" id="inputLoanSEProfessional" name="inputLoanSEProfessional" value="Professional">
                    ...
                    <div class="row pt-4 border-bottom border-primary py-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control form-control-sm text-uppercase" id="inputLoanGAIncome" placeholder="Required">
                        </div>
                        <div class="col-md-4">
                            <label for="inputLoanJobPositionName" class="pb-2">Years with Employer in Business</label>
                            <div class="row">
                                <div class="col-md-4">
                                    <input type="number" class="form-control form-control-sm text-uppercase" id="inputLoanJobPositionName" placeholder="Required">
                                </div>
                                <div class="col-md-2">
                                    <label for="">Yrs.</label>
                                </div>
