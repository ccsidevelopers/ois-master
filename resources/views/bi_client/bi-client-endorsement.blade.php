                                            ...
                                            <div class="col-md-9">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-5">
                                                        ...
                                                        <div class="box box-danger">
                                                            <div class="box-header with-border">
                                                                <div class = "box-title">TAT Selection</div><small style="color: orange;"> (Optional Field)</small>
                                                            </div>
                                                            <div class="box-body">
                                                                <div class="form-group">
                                                                    <div class="row">
...
class="form-control" id="acct_nationality">--}}
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="box box-danger">
                                                            <div class="box-header with-border">
                                                                <div class = "box-title">Attachments</div><small style="color: orange;"> (Optional Field)</small>
                                                            </div>
                                                            <div class="box-body">
                                                                <div class="row">
                                                                    <div class="form-group col-md-6">
