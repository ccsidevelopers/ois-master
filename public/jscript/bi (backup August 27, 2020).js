...
function getDash()
{
    ...
    ({
        ...
        {
            console.log(data);
            $('#gen_endorse_count').html(data[0].length);
            $('#pending_account_count').html(data[1].length);
            $('#finished_count').html(data[2].length);
            $('#returned_account_count').html(data[3].length);
