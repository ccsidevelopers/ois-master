...
var endorsementDetailsEditBool = false;
...
$(document).ready(function ()
{
    ...
    $.ajax({
        ...
        url : 'tfs_bi_get_bi_account_name',
        type : 'get',
        success : function (data)
        {
...
function get_general_table()
{
    ...
    ({
        ...
        "ajax":
            {
                url: "tfs_bi_client_get_general_table",
                data: function (d)
                {
        ...
        "columns":
            [
                {data: 'button_edit', name: 'bi_endorsements.id', "searchable": false}, //1
                {data: 'party_num', name: 'bi_endorsements.party_num', visible:false}, //2
                {data: 'contract_num', name: 'bi_endorsements.contract_num', visible:false}, //3
                {data: 'due', name: 'bi_endorsements.date_time_due'}, //4
                {data: 'tor', name: 'bi_endorsements.type_of_endorsement_bank'}, //5
                ...
                {data: 'due_status', name: 'bi_endorsements.id', orderable: 'false', searchable: 'false'},
                {
                ...
                {data: 'endorse_id', name: 'bi_endorsements.id'}, //15
                // {
    ...
    $('#type_package').change(function ()
    {
        ...
        setTimeout(function () {
            $.ajax({
                ...
                url : 'tfs_bi_get_change_package_check',
                type : 'get',
                data : {
                    'package_id' : id
                },
...
$('#btn_bi_submit_endorsement').click(function ()
{
    ...
    function endorseAccountFunc()
    {
        ...
        else if(what_to_submit == 'cc_bank')
        {
            ...
            {
                if(if_no_check === 0 || if_no_attachment === 0 || $('#acct_last_pdrn').val() == '' || $('#acct_first_pdrn').val() == '' || $('#dealer_num').val() == '' || $('#contract_num').val() == '' || $('#acct_endorsedby_pdrn').val() == '')
                {
                    $('#modal_inc').modal('show');
                }
                else
                {
                    ...
                    ({
                        type: 'get',
                        url: 'tfs_bi_check_double_endorse',
                        data: {
                        ...
                        success: function(data)
                        {
                            if(!data || type_endo == 'Re-call')
                            {
                                $.ajax
                                ({
                                    type : 'post',
                                    url : 'tfs_bi-pdrn-endorse-submit',
                                    data :
                                        {
                                            'dealer_num' : $('#dealer_num').val(),
                            ...
                            {
                                alert('Account is already endorsed if you want to continue endorsing this account change the type of endorsement to "Re-Call".');
                            }
                        }
                    });
                }
            ...
            else if(type_cc_bank == 'BVR')
            {
                ...
                if(if_no_attachment === 0 || $('#acctFNameBVR').val() == '' || $('#acctLNameBVR').val() == '' ||  $('#requestorNameBVR') == '' ||  count_bus == null  || $('#dealer_num').val() == '' || $('#contract_num').val() == '' || $('#requestorNameBVR').val() == '')
                {
                    $('#modal_inc').modal('show');
                }
                else
                    ...
                    ({
                        ...
                        success: function(data)
                        {
                            if(!data || type_endo == 'Re-call')
                            {
                                ...
                                ({
                                    type : 'post',
                                    url : 'tfs_bi-client-bvr-endorse-submit',
                                    data :
                                        {
                                            'dealer_num' : $('#dealer_num').val(),
                                            'party_num' : $('#party_num').val(),
            ...
            else if(type_cc_bank == 'EVR')
            {
                ...
                if(if_no_attachment === 0 || $('#acctFNameEVR').val() == '' || $('#acctLNameEVR').val() == '' ||  $('#requestorNameEVR') == '' || count_emp == null  || $('#dealer_num').val() == '' || $('#contract_num').val() == '' || $('#requestorNameEVR').val() == '')
                {
                    $('#modal_inc').modal('show');
                }
                else
                    ...
                    ({
                        ...
                        success: function(data)
                        {
                            if(!data || type_endo == 'Re-call')
                            {
                                ...
                                ({
                                    type : 'post',
                                    url : 'tfs_bi-client-evr-submit-endorse',
                                    data :
                                        {
                                            'dealer_num' : $('#dealer_num').val(),
                                            'party_num' : $('#party_num').val(),
            ...
            else if(type_cc_bank == 'Full C.I')
            {
                if(if_no_attachment === 0 || $('#acctFNameFullCI').val() == '' || $('#acctLNameFullCI').val() == '' ||  $('#requestorNameFullCI') == ''  || $('#dealer_num').val() == '' || $('#contract_num').val() == '' || $('#requestorNameFullCI').val() == '')
                {
                    $('#modal_inc').modal('show');
                }
                else
                    ...
                    ({
                        ...
                        success: function(data)
                        {
                            if(!data || type_endo == 'Re-call')
                            {
                                ...
                                ({
                                    type : 'post',
                                    url : 'tfs_bi_client_fullci_submit_endorse',
                                    data :
                                        {
                                            'dealer_num' : $('#dealer_num').val(),
                                            'party_num' : $('#party_num').val(),
                                            'contract_num' : $('#contract_num').val(),
                                            'acct_fname' : $('#acctFNameFullCI').val(),
                                            'acct_mname' : $('#acctMNameFullCI').val(),
                                            'acct_lname' : $('#acctLNameFullCI').val(),
                                            'client_rem'  : $('#txtClientRemarksFullCI').val(),
                                            'requestor_name' : $('#requestorNameFullCI').val(),
                                            'type_endo' : type_endo
                                        },
                                    beforeSend : function ()
                                    {
...
function uploadAttachEndo(form)
{
    ...
    ({
        ...
        url: 'tfs_bi_submit_endorsement_files',
        type: 'post',
        data: form,
        contentType: false,
        processData: false,
...
function clear(type) {
    ...
    $('#acctFNameFullCI').val('');
    $('#acctMNameFullCI').val('');
    $('#txtClientRemarksFullCI').val('');
    $('#NewEndorsement').iCheck('check');
...
$('#bi_client_return_table').on('click','.btn_upload_remove', function () {
    ...
    else
    {
        $.ajax
        ({
            url: 'tfs_bi_remove_attachment_logs',
            type: 'post',
            data: {
                'id' : id,
...
function bi_finish()
{
    ...
    ({
        ...
        "ajax":
            {
                url: "tfs_bi-client-table-finished",
                data: function (d)
                {
...
$('.bi-client-dash-class').click(function () {
    ...
    if (gethref == '#tab_a') {
        ...
        if ($('' + gethref + '').hasClass('active')) {
            ...
            ({
                type : 'get',
                url : 'tfs_bi-client-update-finished-stat',
                success : function()
                {
                    $('#notifFinished').hide();
                }
        ...
        if ($('' + gethref + '').hasClass('active')) {
            ...
            ({
                type : 'get',
                url : 'tfs_bi-client-update-return-stat',
                success : function()
                {
                    $('#notifReturned').hide();
                }
...
$('.bi_client_side_class').click(function () {
    ...
    if (gethref == '#bi_client_endorse') {
        ...
        else if (bi_side_table == false)
        {
            ...
            ({
                type : 'get',
                url : 'tfs_bi-client-return-notif',
                success : function(data)
                {
                    console.log(data);
...
function message_notif()
{
    ...
    ({
        type : 'get',
        url : 'tfs_bi-client-get-message-notif',
        success : function(data)
        {
            console.log(data);
            var mes = '';
...
function changeStatMessage()
{
    ...
    ({
        type : 'get',
        url : 'tfs_bi-client-change-mess-notif',
        success : function()
        {
            console.log('success');
        }
...
$('#BtnuploadExcelBiBulk').click(function()
{
    ...
    if(uploadExcel != null)
    {
        ...
        ({
            type: 'post',
            url: 'tfs_bi-client-upload-bulk-excel',
            contentType: false,
            processData: false,
            async : true,
            data: formData,
...
$('#BtnBulkEndorseSubmitExcel').click(function()
{
    ...
    if(to_alert == '' && bulkEndorseBool != false)
    {
        ...
        ({
            ...
            type: 'post',
            url: 'tfs_bi-client-send-bulk-endorse',
            contentType: false,
            processData: false,
            async: true,
            data: formData,
...
function cancelTable()
{
    ...
    ({
        ...
        initComplete : function ()
        {
            ...
            if(what_to_submit =='cc_bank')
            {
                table_cancel.column(3).visible(false);
                table_cancel.column(8).visible(false);
                table_cancel.column(9).visible(false);
            }
            else
            {
                table_cancel.column(3).visible(true);
                table_cancel.column(4).visible(false);
                table_cancel.column(8).visible(true);
                table_cancel.column(9).visible(true);
            }
        }
...
$('#btnSelectForm').change(function ()
{
    ...
    '                                                                        </div>' +
            ...
            '                                                        </div>' +
                ...
                '                                                                    <input type="text" class="form-control" placeholder="" id="acct_endorsedby_pdrn" name="acct_endorsedby_pdrn" value="'+userNameGen+'">\n' +
                '                                                                </div>\n' +
                '                                                            </div>\n' +
                '                                                           </div>\n' +
                '                                                    </div>\n' +
        ...
        $('#bi_pdrn_coborrower_count').on('change',function ()
        {
            ...
            for(var i = 0; i<count_cobo; i++)
            {
                coobs +=
                    ...
                    '                        z                             <option value = "Others">Others</option>' +
                    '                                                     </select></span>' +
                    '                                                     </div>' +
    ...
    else if($(this).val()=='BVR')
    {
        $('#type_of_request_selection_bi').html('' +
            ...
            '                                                                        <div class = "form-group col-md-4">\n' +
            '                                                                            <label>Last Name:</label><small style="color: red;"> (Required Field)</small>\n' +
            '                                                                            <input type="text" class = "form-control" id = "acctLNameBVR" name="acctLName">\n' +
            '                                                                        </div>\n' +
            '                                                                        <div class = "form-group col-md-4">\n' +
            '                                                                            <label>First Name:</label><small style="color: red;"> (Required Field)</small>\n' +
            '                                                                            <input type="text" class = "form-control" id = "acctFNameBVR" name="acctFName">\n' +
            '                                                                        </div>\n' +
            '                                                                        <div class = "form-group col-md-4">\n' +
            '                                                                            <label>Middle Name:</label><small style="color: orange;"> (Optional Field)</small>\n' +
            '                                                                            <input type="text" class = "form-control" id = "acctMNameBVR" name="acctMName">\n' +
            '                                                                        </div>' +
            '                                                           </div>' +
            '                                                       </div>' +
            '                                                   </div>\n' +
            ...
            '                                                                <div class="form-group col-xs-12">   \n' +
            '                                                                    <label>Name of Requestor:</label>       \n' +
            '                                                                    <input type="text" class="form-control" placeholder="" id="requestorNameBVR" name="requestorName"  value="'+userNameGen+'">                \n' +
            '                                                                </div>                                       \n' +
            '                                                            </div>                                            \n' +
            '                                                        </div>                                        \n' +
            '                                                    </div>\n' +
    ...
    else if($(this).val()=='EVR')
    {
        ...
        '                                                        </div>' +
                    ...
                    '                                                        <div class="form-group col-xs-12">\n' +
                    '                                                            <label>Name of Requestor:</label>\n' +
                    '                                                            <input type="text" class="form-control" placeholder="" id="requestorNameEVR" name="requestorNameEVR" value="'+userNameGen+'">\n' +
                    '                                                        </div>\n' +
                    '                                                    </div>\n' +
                    '                                                </div>\n' +
                    '                                            </div>' +
    ...
    else if($(this).val()=='Full C.I')
    {
        $('#type_of_request_selection_bi').html('' +
            ...
            '                                                        <div class="form-group col-md-4">\n' +
            '                                                            <label>Last Name:</label><small style="color: red;"> (Required Field)</small>\n' +
            '                                                            <input id="acctLNameFullCI" name="acctLNameFullCI" type="text" class="form-control" placeholder="">\n' +
            '                                                        </div>\n' +
            '                                                        <div class="form-group col-md-4">\n' +
            '                                                            <label>First Name:</label><small style="color: red;"> (Required Field)</small>\n' +
            '                                                            <input id="acctFNameFullCI" name="acctFNameFullCI" type="text" class="form-control" placeholder="">\n' +
            '                                                        </div>\n' +
            '                                                        <div class="form-group col-md-4">\n' +
            '                                                            <label>Middle Name:</label><small style="color: orange;"> (Optional Field)</small>\n' +
            '                                                            <input id="acctMNameFullCI"" name="acctMNameFullCI" type="text" class="form-control" placeholder="">\n' +
            '                                                        </div>\n' +
            '                                                    </div>\n' +
            '                                                </div>\n' +
            '                                            </div>\n' +
            ...
            '                                                        <div class="form-group col-xs-12">\n' +
            '                                                            <label>Remarks:</label><small style="color: orange;"> (Optional)</small>\n' +
            '                                                            <textarea id="txtClientRemarksFullCI" class="form-control" rows="3"></textarea>\n' +
            '                                                        </div>\n' +
            '                                                    </div>\n' +
            '                                                </div>\n' +
            '                                            </div>\n' +
            ...
            '                                                        <div class="form-group col-xs-12">\n' +
            '                                                            <label>Name of Requestor:</label>\n' +
            '                                                            <input type="text" class="form-control" placeholder="" id="requestorNameFullCI" name="requestorNameFullCI" value="'+userNameGen+'">\n' +
            '                                                        </div>\n' +
            '                                                    </div>\n' +
            '                                                </div>\n' +
            '                                            </div>' +
        ...
        $('#btn_bi_submit_endorsement').attr('name', 'Full C.I');
    }
    else
    {
        $('#type_of_request_selection_bi').html('');
...
$('#bi_client_return_table').on('click','.btn_viewReason',function ()
{
    ...
    (
        {
            type: 'get',
            url: 'tfs_bi-get-reason-of-delay',
            data: {
                'id' : get_endorseID
            },
            success: function(data)
...
$('#btnReturnAccount').on('click',function(e)
{
    ...
    ({
        ...
        url: 'tfs_bi-get-return-checklist-return',
        type: 'post',
        contentType: false,
        processData: false,
        async : true,
...
$('#view_info_details').on('click', '#submitAdditionalFile', function()
{
    ...
    ({
        ...
        type: 'post',
        url: 'tfs_bi-client-additional-files-any',
        contentType: false,
        processData: false,
        async: true,
        data: formData,
        success : function(data)
        {
            ...
            if(remarks != '')
            {
                ...
                ({
                    type : 'get',
                    url : 'tfs_bi-client-add-rem-add-files-new',
                    data :
                        {
                            'rem' : remarks,
                            'add_id' : data[0],
...
$('#ack_encoded').click(function()
{
    ...
    $.ajax({
        type: 'get',
        url: 'tfs_bi_endorse_encoded_account',
        data: {
            'id' : id,
        ...
        {
            // console.log(data);
            alert('Account Successfully Endorsed');
...
$('#request_cancel_submit').click(function()
{
    ...
    if(confirm('Are you sure to submit request?'))
    {
        ...
        $.ajax({
            type: 'get',
            url: 'tfs_bi_client_request_cancellation',
            data: {
...
{
    window.open('tfs_bi-client-dl-bulk','_blank');
});
...
$('.edit_funq').each(function()
{
    var table_id = $(this).attr('id');
    $('#'+table_id+'').on('click', '.client_edit_req', function()
    {
        var endorsement_id = $(this).attr('id');
        $('#editClickedBi').removeClass('btn-danger');
        $('#editClickedBi').addClass('btn-info');
        $('#editClickedBi').text('Edit Details');
        $.ajax
        ({
            type: 'get',
            url: 'tfs_bi_client_check_endorse_time',
            data: {
                'id' : endorsement_id
            },
            success: function(data)
            {
                ...
                {
                    // console.log(data);
                    endorsementDetailsEditBool = true;
                    $('.data_roll_test').each(function()
                    {
                        $(this).val(data[1][0][$(this).attr('identifier')]).attr('disabled', true);
                    });

                    $('#modal-edit-endorsement-details').modal('show');
                    $('#EditEndorsement').attr('name', btoa(endorsement_id));
                }
                else
                {
                    $('#EditEndorsement').attr('name', '');

                    $('#modal-edit-endorsement-details-warning').modal('show');

                    setTimeout(function()
                    {
                        $('#modal-edit-endorsement-details-warning').modal('hide');
                    },3000);
                }

                $('#edit_attachment_bbody').hide();

                $('.data_roll_test_files').each(function()
                {
                    $(this).val('');
                });
            },
            error: function(e)
            {
                alert('Error occured please contact the web admin for assistance');
            }
        });
    });
});
...
$('#editClickedBi').click(function()
{
    var c_data = '{"data": {';
    var recall_data = '';

    if($('.data_roll_test').is(':disabled'))
    {
        $('.data_roll_test').attr('disabled', false);
        $('#editClickedBi').removeClass('btn-info');
        $('#editClickedBi').addClass('btn-danger');
        $('#editClickedBi').text('Cancel');

        $('.data_roll_test').each(function()
        {
            c_data += '"'+$(this).attr('identifier')+'":"'+$(this).val()+'",';
        });
        c_data = c_data.slice(0, -1);
        c_data += '}}';

        if(endorsementDetailsEditBool)
        {
            sessionStorage.setItem('test', c_data);
            endorsementDetailsEditBool = false;
        }
    }
    else
    {
        ...
        {
            $('.data_roll_test').attr('disabled', true);
            $('#editClickedBi').removeClass('btn-danger');
            $('#editClickedBi').addClass('btn-info');
            $('#editClickedBi').text('Edit Details');
            recall_data = JSON.parse(sessionStorage.test);
            // var test_each = Object.keys(recall_data["data"]).length;

            $('.data_roll_test').each(function()
            {
                $(this).val(recall_data["data"][$(this).attr('identifier')]);
            });
...
$('#editAttachExpand').click(function()
{
    $('#edit_attachment_bbody').slideToggle(500);

    if($('#edit_attachment_bbody').is(':visible'))
    {
        $('#edit_attachment_bbody').children('i').removeClass('glyphicon glyphicon-resize-full');
        $('#edit_attachment_bbody').children('i').addClass('glyphicon glyphicon-resize-small');
    }
    else
    {
        $('#edit_attachment_bbody').children('i').removeClass('glyphicon glyphicon-resize-small');
        $('#edit_attachment_bbody').children('i').addClass('glyphicon glyphicon-resize-full');
    }
});

$('#EditEndorsement').click(function()
{
    var go_bool = false;
    var data_to_send = {};
    ...
    var file_names = '';
    var file_counter = 0;
    data_to_send["id"] = atob($(this).attr('name'));
    ...
    $('.data_roll_test').each(function()
    {
        ...
        data_to_send[$this.attr('identifier')] = $this.val();
        data_to_send_index += $this.attr('identifier') + '||-||-||';
    });
    data_to_send_index = data_to_send_index.slice(0, -8);
    ...
    $('.data_roll_test_files').each(function()
    {
        ...
        {
            file_counter++;
            formData.append($(this).attr('identifier'), $('.data_roll_test_files[identifier="'+$(this).attr('identifier')+'"]').prop('files')[0]);
        }
        else
        {
            formData.append($(this).attr('identifier'), null);

        }
        file_names += $(this).attr('identifier') + '||-||-||';
    });
    file_names = file_names.slice(0, -8);

    formData.append('data', JSON.stringify(data_to_send));
    formData.append('data_index', data_to_send_index);
    ...
    if(file_counter > 0)
    {
        if(go_bool)
        {
            if(confirm('Are you sure to submit the edited endorsement? All the attachment will be updated and the existing files will be deleted'))
            {
                $('#EditEndorsement').attr('disabled', true);
                $.ajax({
                    type: 'post',
                    url: 'tfs_bi_upload_edited_endo_file',
                    contentType: false,
                    processData: false,
                    async : true,
                    data:  formData,
                    success: function(data)
                    {
                        alert('Endorsement Successfully Edited');
                        $('#EditEndorsement').attr('disabled', false);
                        if(bi_client_pen)
                        {
                            table_pending.draw();
                        }
        ...
        {
            alert('Fill-up the required fields to continue.');
        }
    }
    else
    {
        alert('Attach atleast 1 file');
    }


});

$('.data_roll_test_files').change(function(data)
{
    if($(this).val() != '')
    {
        if(data.target.files[0].size >= 27262976)
        {
