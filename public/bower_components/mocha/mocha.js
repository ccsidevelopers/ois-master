...
function HTML(runner, root) {
  ...
  var self = this
    ...
    , report = fragment('<ul id="mocha-account_report"></ul>')
    , stack = [report]
    , progress
    , ctx
  ...
  runner.on('test end', function(test){
    ...
    // Don't call .appendChild if #mocha-account_report was already .shift()'ed off the stack.
