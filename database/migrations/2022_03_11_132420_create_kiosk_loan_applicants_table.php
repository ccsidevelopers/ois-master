...
class CreateKioskLoanApplicantsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('kiosk_loan_applicants', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->string('pre_unit_number_bld_st_subd_brgy');
            $table->string('pre_city_municipality');
            $table->string('pre_province');
            $table->string('per_unit_number_bld_st_subd_brgy');
            $table->string('per_city_municipality');
            $table->string('per_province');
            $table->string('work_email_address');
            $table->string('work_landline_number');
            $table->string('work_unit_number_bld_st_subd_brgy');
            $table->string('work_city_municipality');
            ...
            $table->string('loan_extra_col_1');
            $table->string('loan_extra_col_2');
            $table->string('loan_extra_col_3');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('kiosk_loan_applicants');
    }
}
