...
class CreateAuditPhoneFieldCheckingTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('audit_field_checking', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('audit_phone_field_checking');
    }
}
