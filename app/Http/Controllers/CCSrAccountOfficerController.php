...
class CCSrAccountOfficerController extends Controller
{
    public function ccsaopanel()
    {
        ...
        if ($webStatus->web_status === 1) {
            ...
            if (Auth::user() == null) {
                ...
                return view('cc_dept.sao.cc-sao-master', compact('javs'));
            }
            return redirect()->route('privilege-error');
        }
    }

    public function cc_sao_get_table_accounts()
    {
...
//                }
    ...
    public function cc_sao_get_table_acknowledge()
    {
        $getAuth = DB::table('users')
            ->select('client_check')
            ->where('id', Auth::user()->id)
...
//                }
    ...
    public function cc_sao_get_table_return()
    {
        $getAuth = DB::table('users')
            ->select('client_check')
            ->where('id', Auth::user()->id)
...
//                }
    ...
    public function cc_sao_table_finished()
    {
        $getAuth = DB::table('users')
            ->select('client_check')
            ->where('id', Auth::user()->id)
...
//                }
    ...
    public function cc_sao_acknowledge_account(Request $request)
    {
    ...
    public function cc_sao_cancel_account(Request $request)
    {
    ...
    public function cc_sao_send_report(Request $request)
    {
        $removeScript = new ScriptTrimmer();
        $trims = new Trimmer();
...
//            $email->ReportSendCC($id, Auth::user()->id, $user->roles->first()->name);
    ...
    public function cc_sao_view_remarks(Request $request)
    {
        $getData = DB::table('bi_endorsements')
            ->select('report_remarks')
            ->where('id', $request->id)
            ->get();

        return response()->json([$getData[0]->report_remarks]);
    }

    public function cc_sao_dl_report(Request $request)
    {
        $trims = new Trimmer();
    ...
    public function cc_sao_get_tele()
    {
        $getAuth = DB::table('users')
            ->select('client_check')
            ->where('id', Auth::user()->id)
        ...
        return response()->json($arrayToSend);
    }

    public function cc_sao_assign_tele(Request $request)
    {
        $trimmer = new Trimmer();
        $account = new bi_endorsement();
    ...
    public function cc_sao_tele_success_accounts()
    {
        $getAuth = DB::table('users')
            ->select('client_check')
            ->where('id', Auth::user()->id)
...
//                }
    ...
    public function cc_tele_dl_report(Request $request)
    {
        $id = base64_decode($request->id);
    ...
    public function cc_sao_proceed_acknowledge(Request $request)
    {
...
//            }
    ...
    public function cc_sao_file_to_tele(Request $request)
    {
        $removeScript = new ScriptTrimmer();
        $id = base64_decode($request->id);
    ...
    public function audit_ao_file_dl(Request $request)
    {
        ...
        {
            if(storage_path('/account_report/' . $dlPath))
            {
                return 'No Available Report at the Moment.';
            }
            else
            {
                return response()->download(storage_path('/account_report/' . $dlPath));
            }
        }
        else
        {
    ...
    public function cc_sao_general_search(Request $request)
    {
        $getAuth = DB::table('users')
            ->select('client_check')
            ->where('id', Auth::user()->id)
...
//                }
    ...
    public function cc_sao_get_dash()
    {
...
//            ->count();
    ...
    public function cc_sao_dl_ack(Request $request)
    {
    ...
    public function cc_sao_get_assigned_table()
    {
        $getAuth = DB::table('users')
            ->select('client_check')
            ->where('id', Auth::user()->id)
...
//                }
    ...
    public function cc_sao_get_assigned_to_acct(Request $request)
    {
    ...
    public function cc_sao_transfer_to_tele(Request $request)
    {
        $trimmer = new Trimmer();
...
//        }
    ...
    public function cc_sao_cancel_table(Request $request)
    {
        $getAuth = DB::table('users')
            ->select('client_check')
            ->where('id', Auth::user()->id)
...
//                }
    ...
    public function cc_sao_pending_cancel_table(Request $request)
    {
        $getAuth = DB::table('users')
            ->select('client_check')
            ->where('id', Auth::user()->id)
...
//            ->where('bi_endorsements.cancel_bool', 'Pending Cancel');
...
//                }
    ...
    public function cc_sao_cancel_new_account(Request $request)
    {
        $removeScript = new ScriptTrimmer();
        $account = new bi_endorsement();
        $account = $account::find($request->id);
...
//                    $email->BICancellationRequestNotifSAO($request);
    ...
    public function cc_sao_hold_new_account(Request $request)
    {
    ...
    public function cc_sao_return_check_data_upon(Request $request)
    {
        $checkData = '';
    ...
    public function cc_sao_get_return_checklist_return_upon(Request $request)
    {
        $removeScript = new ScriptTrimmer();
        $id = $request->id;
    ...
    public function cc_sao_get_reason_of_delay(Request $request)
    {
    ...
    public function cc_sao_return_to_tele(Request $request)
    {
        $removeScript = new ScriptTrimmer();
        $trims = new Trimmer();
        ...
        else if($status == 3)
        {
            ...
            $logs->remarks = $removeScript->scripttrim($trims->trims($request->remarks)) ;
            $logs->save();
        }
    ...
    public function cc_sao_uncancel_account(Request $request)
    {
        $data = DB::table('bi_endorsements')
            ->where('id', $request->id)
            ->select('cancel_bool')
    ...
    public function cc_sao_unhold_account(Request $request)
    {
        $data = DB::table('bi_endorsements')
            ->where('id', $request->id)
            ->get();
    ...
    public function cc_sao_check_type_tat(Request $request)
    {
        $data = DB::table('bi_endorsements')
            ->where('id', $request->id)
            ->get();
    ...
    public function cc_sao_check_if_sitel(Request $request)
    {
        $daysToAdd = 0;
        $type_of_tat = '';
        $ito_return = '';
    ...
    public function cc_sao_get_account_info(Request $request)
    {
        $accountInfo = DB::table('bi_endorsements')
            ->where('id', $request->id)
            ->get();
    ...
    public function cc_sao_get_client_type()
    {
    ...
    public function cc_sao_granting_tele(Request $request)
    {
    ...
    public function cc_sao_get_general_mon_table(Request $request)
    {
        $getAuth = DB::table('users')
            ->select('client_check')
            ->where('id', Auth::user()->id)
...
//                }
    ...
    public function cc_sao_get_bi_checkings(Request $request)
    {
    ...
    public function cc_sao_get_selected_packages_checkings(Request $request)
    {
    ...
    public function cc_sao_add_checking_packages_api_endo(Request $request)
    {
        DB::table('bi_endorsements')
            ->where('id', $request->id)
            ->update([
