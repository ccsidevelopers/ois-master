            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-xs-6">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"><?php echo e($endorsement); ?></span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                ...
                <div class="col-lg-3 col-xs-6">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"><?php echo e($tatAccounts); ?></span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                ...
                <div class="col-lg-3 col-xs-6">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"><?php echo e($overdueAccount); ?></span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                ...
                <div class="col-lg-3 col-xs-6">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">Due Account <?php echo e($timeStamp->toFormattedDateString()); ?></span>
                            <span class="info-box-number"><?php echo e($dueAccount); ?></span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="nav-tabs-custom">
                                        <ul class="nav nav-tabs">
                                            ...
                                            <li><a href="#tab_6" id="client_tab6" data-toggle="tab">Return Accounts</a></li>
                                        ...
                                        <div class="tab-content">
                                                        ...
                                                        <div class="box-body" data-toggle="tooltip" title="You can select for the range of date of endorsement that you want to view">
                                                            <div class="form-group-right">
                                                                ...
                                                                <div class="input-group margin date_range_container">
                                                                    ...
                                                                    <!-- /btn-group -->
                                                                    <input type="text" id="datepickerminRevised" class="form-control minRevised">
                                                                    ...
                                                                    <input type="text" id="datepickermaxRevised" class="form-control maxRevised">
                                            ...
                                            <div class="tab-pane" id="tab_6">
                                                    ...
                                                    <div class="box box-danger">
                                                        ...
                                                        <div class="box-body" data-toggle="tooltip" title="You can select for the range of date of endorsement that you want to view">
                                                            <div class="form-group-right">
                                                                ...
                                                                <input type="radio" class="viewable" name="viewable6" id="rad_all6" value="All">All
                                                                <input type="radio" class="viewable" name="viewable6" id="rad_daterange6" value="Date Range">Date Range
                                                                ...
                                                                <div class="input-group margin date_range_container">
                                                                    ...
                                                                    <!-- /btn-group -->
                                                                    <input type="text" id="datepickerminReturn" class="form-control minReturn">
                                                                    <input hidden id="minReturn" type="date">
                                                                    ...
                                                                    <input type="text" id="datepickermaxReturn" class="form-control maxReturn">
                                                                    <input hidden id="maxReturn" type="date">
                                                ...
                                                <table id="client-return-account" class="tableendorse table-hover table-condensed" width="100%">
                                                    <thead>
                                                    <tr>
                                                        <th>Id</th>
                                                        <th>Account Name</th>
