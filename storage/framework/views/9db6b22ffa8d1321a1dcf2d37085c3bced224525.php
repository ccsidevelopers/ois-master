                                            ...
                                            <div class="box-body">
                                                ...
                                                <div class="form-group" id="gen_search_date_pick_holder">
                                                    <div class="input-group margin" style="" id="">
                                                        ...
                                                        <input id="gen_search_min" type="date" class="form-control gen_search_date_range_dates" value="<?php echo e(date('Y-m-d')); ?>">
                                                        <div class="input-group-btn">
                                                            <label for="" class="btn btn-default">To</label>
                                                        </div>
                                                        <input id="gen_search_max" type="date" class="form-control gen_search_date_range_dates" value="<?php echo e(date('Y-m-d')); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
