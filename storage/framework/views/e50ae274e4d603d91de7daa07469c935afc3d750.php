                                                    ...
                                                    <div class="box-body">
                                                        ...
                                                        <div class="form-group" id="gen_client_date_pick_holder">
                                                            <div class="input-group margin" style="" id="">
                                                                ...
                                                                <input id="gen_client_min" type="date" class="form-control gen_client_date_range_dates" value="<?php echo e(date('Y-m-d')); ?>">
                                                                <div class="input-group-btn">
                                                                    <label for="" class="btn btn-default">To</label>
                                                                </div>
                                                                <input id="gen_client_max" type="date" class="form-control gen_client_date_range_dates" value="<?php echo e(date('Y-m-d')); ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="box-body">
                                                        ...
                                                        <div class="form-group" id="fin_client_date_pick_holder">
                                                            <div class="input-group margin" style="" id="">
                                                                ...
                                                                <input id="fin_client_min" type="date" class="form-control fin_client_date_range_dates" value="<?php echo e(date('Y-m-d')); ?>">
                                                                <div class="input-group-btn">
                                                                    <label for="" class="btn btn-default">To</label>
                                                                </div>
                                                                <input id="fin_client_max" type="date" class="form-control fin_client_date_range_dates" value="<?php echo e(date('Y-m-d')); ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
