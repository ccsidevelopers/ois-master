                                                                            ...
                                                                            <div class="form-group">
                                                                                <span id="show_client_branch" hidden>
                                                                                    ...
                                                                                    <select id="client_branch" class="form-control">
                                                                                        <?php $__currentLoopData = $client_branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client_branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                            <option id="<?php echo e($client_branch->id); ?>" name="<?php echo e($client_branch->name); ?>" value="<?php echo e($client_branch->id); ?>"><?php echo e($client_branch->name); ?></option>
                                                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                                    </select>
                                                                                </span>
                                                                            </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-12 form-group">
                                                                            <select class="form-control" id="selected_bi">
                                                                                <?php $__currentLoopData = $bi_clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bi_client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                    <option value="<?php echo e($bi_client->id); ?>"><?php echo e($bi_client->bi_account_name.' '.$bi_client->account_location); ?></option>
                                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                            </select>
                                                                        </div>
                                                                    </div>
...
<?php $__env->startPush('jscript'); ?>
    ...
    <script src="<?php echo e(asset('jscript/admin.js')); ?>"></script>

<?php $__env->stopPush(); ?>

<?php echo $__env->make('admin.template.master', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>