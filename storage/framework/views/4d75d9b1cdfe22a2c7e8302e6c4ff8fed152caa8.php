...
<br>
<p>Here's the details of endorsement:</p>
<ul class="list-group">
    <li class="list-group-item">Date/Time Endorse: <?php echo e($dateTimeEndorse); ?></li>
    <li class="list-group-item">Account Name: <?php echo e($acctName); ?></li>
    <li class="list-group-item">Address: <?php echo e($address); ?></li>
    <li class="list-group-item">Name of Requestor: <?php echo e($nameOfRequestor); ?></li>
    <li class="list-group-item">Type of Loan: <?php echo e($typeOfLoan); ?></li>
    <li class="list-group-item">Type of Request: <?php echo e($typeOfRequest); ?></li>
    <li class="list-group-item">Client Remarks: <?php echo e($remarks); ?></li>
</ul>
