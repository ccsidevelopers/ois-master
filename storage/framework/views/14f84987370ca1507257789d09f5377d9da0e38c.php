                                                ...
                                                <div class="row">
                                                    <div class="form-group col-xs-6">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" id="DateVisit" name="DateVisit" data-inputmask="'alias': 'yyyy-mm-dd'" data-mask >
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="box box-solid">
                                            ...
                                            <div class="box-body" hidden id="box_body_encode">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12 form-group">
                                                        <label for="select_encode_template">Select Type of Request: </label>
                                                        <select class="form-control" id="select_encode_tor">
                                                    ...
                                                    <div class="col-md-12 form-group">
                                                        <table id="endorse_encode_accountv2" style="word-wrap: break-word; table-layout: fixed; width: 100%;" class="table-hover new_encoding_tempv2">
                                                            <tbody>
                                                            </tbody>
                                                        </table>
                                                    </div>

                                                    <div class="row new_encoding_tempv2" hidden>
                                                        <div class="col-md-12">
                                                            <button type="button" name="save_only" hidden id="btn_save_encode_tempv2" class="btn btn-solid btn-info btn-sm form-control btn_encode_savev2">Save (only) Encoded Data</button>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <button type="button" name="save_final" hidden id="btn_final_save_encode_tempv2" class="btn btn-solid btn-success btn-sm form-control btn_encode_savev2">Save Final Data</button>
                                                        </div>
                                                    </div>
                ...
                <div class="modal modal-info fade" id="modal-uploadingFile">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p style="text-align: center">Uploading Report...  <img src="<?php echo e(asset('dist/img/loading.gif')); ?>" style="width: 5%;"></p>
                            </div>
                            <div class="modal-footer">
...
<?php $__env->startPush('leftsidebar'); ?>
    <?php echo $__env->make('bank_dept.ci.ci-leftsidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopPush(); ?>
...
//                console.log('change');
    ...
    <script src="<?php echo e(asset('jscript/ci.js?n='.$javs)); ?>"></script>
    <script src="<?php echo e(asset('jscript/getLatLong.js?n='.$javs)); ?>"></script>
    <script src="<?php echo e(asset('jscript/idle/jquery.idle.js?n='.$javs)); ?>"></script>
    <script src="<?php echo e(asset('jscript/detect-user-idle.js?n='.$javs)); ?>"></script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('bank_dept.ci.template.master', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>