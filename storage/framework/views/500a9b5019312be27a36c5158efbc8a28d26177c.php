<div class="content-wrapper">
    ...
    <section class="content">
            ...
            <div class= "box-body">
                <div class="nav-tabs-custom">
                    ...
                    <div class = "tab-content">
                        <div class="nav-tabs-custom">
                            <?php if(Auth::user()->authrequest  == 'direct_enc'): ?>
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class=""><a href="#tab_tab_3" id="upload_endorsement_tab" data-toggle="tab" class = "client_bi_endorsement_class">Online Applicants</a></li>
                                </ul>
                            <?php else: ?>
                                <ul class="nav nav-tabs">
                                    <li class="active"><a href="#tab_tab_1" id="encode_endosement_tab" data-toggle="tab" class = "client_bi_endorsement_class">Encode Endorsement</a></li>
                                        ...
                                        <div class="row">
                                            <div class="col-md-9">
                                                <div class="row">
                                                    ...
                                                    <?php if(Auth::user()->client_check  == 'tat_selector'): ?>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class ="col-md-12">
                                                                            ...
                                                                            <select class="form-control" id="bi_account_tat">
                                                                                ...
                                                                                <option value ="Regular 7">Regular = 7 days</option>
                                                                                <option value ="Regular 5">Regular = 5 days</option>
                                                                                <option value ="Expedite">Expedite = 3 days</option>
                                                                            </select>
                                                                            <?php endif; ?>
                                                                        </div>
                                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <div class="box box-danger">
                                                    ...
                                                    <div class="box-body">
                                                        <div class="" data-toggle="tooltip" title="Available forms are PDRN, BVR and EVR only">
                                                            <select class="select2" style="width: 100%;" id="btnSelectForm">
                                                                <option selected></option>
                                                                <?php $__currentLoopData = $tors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option value="<?php echo e($tor->type_of_request); ?>"><?php echo e($tor->type_of_request); ?></option>
                                ...
                                <div class="tab-pane" id="tab_tab_3">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="nav-tabs-custom">
                                                <ul class="nav nav-tabs">
                                                    <li class="active"><a href="#tab_1_enc" data-toggle="tab" class="direct_a_class">Pending Applications</a></li>
                                                    <li><a href="#tab_2_enc" data-toggle="tab" class="direct_a_class">Cancelled Applications</a></li>
                                                </ul>
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="tab_1_enc">
                                                        <div class="panel panel-info">
                                                            <div class="panel-heading">
                                                                <h4 style="text-align: center">Applicants for Endorsement</h4>
                                                            </div>
                                                            <div class="panel-body">
                                                                <table class="tableendorse table-hover table-condensed" width="100%" id="applicant_encoded_table">
                                                                    <thead>
                                                                    <tr>
                                                                        <td>ID</td>
                                                    ...
                                                    <!-- /.tab-pane -->
                                                    <div class="tab-pane" id="tab_2_enc">
                                                        <div class="panel panel-danger">
                                                            <div class="panel-heading">
                                                                <h4>
                                                                    <center>Cancelled Applications</center>
                                                                </h4>
                                                            </div>
                                                            <div class="panel-body">
                                                                <table class="tableendorse table-hover table-condensed" width="100%" id="cancelled_applicant_encoded_table">
                                                                    <thead>
                                                                    <tr>
                                                                        <td>ID</td>
                                                                        <td>DATE/TIME ENCODE</td>
        ...
        <div class="modal modal-warning fade" id="modal_loading">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p style="text-align: center">We are processing your request. <img src="<?php echo e(asset('dist/img/loading.gif')); ?>" style="width: 5%;"></p>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="">Select Package: <small
                                                            style="color: orange">(Optional field)</small></label>
        ...
        <div class="modal fade" id="modal-return-attach-encoded">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title">Return Application</h4>
                    </div>
                    <div class="modal-body">
                        <div class="box box-danger">
                            <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" class="form-control" id="return_txtarea_application" rows="4" placeholder="Insert remarks here........"></textarea><br>
                                                <small>Note: <i><b></b>This action will send an email notification to the applicant. Please indicate reason/s of the return application.</i></small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-warning pull-right" id="return_btn_email_to_applicant">Return</button>
                        <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
                    </div>
                </div>
            </div>
        ...
        <div class="modal fade" id="modal-cancel-encoded">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title">Application Cancellation</h4>
                    </div>
                    <div class="modal-body">
                        <div class="box box-danger">
                            <div class="col-md-12">
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="">Remarks:</label>
                                                <textarea type="text" class="form-control" id="cancel_txtarea_application"></textarea><br>
                                                <small>Note: <i><b></b>This action will send an email notification to the applicant. Please indicate reason/s of the application cancellation.</i></small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger pull-right" id="btn_encoded_cancel">Cancel</button>
                        <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
                    </div>
                </div>
            </div>
