<?php $__env->startSection('content'); ?>
    ...
    <div class="modal fade" id="modal-view-tele-direct">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span></button>
                    <h3 class="modal-title">Televerifiers Direct Sending of Report to Client</h3>
                </div>
                <div class="modal-body">
                    <div class = "row" style = "padding-top : 15px;">
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <table class="table-hover table-condensed" width="100%" id="teleLevels">
                                        <thead>
                                        <tr>
                                            <th>USER ID</th>
                                            <th>TELE NAME</th>
...
<?php $__env->startPush('leftsidebar'); ?>
    <?php echo $__env->make('cc_dept.sao.cc-sao-leftsidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopPush(); ?>
...
<?php $__env->startPush('jscript'); ?>
    ...
    <script src="<?php echo e(asset('jscript/cc-sao.js?n='.$javs)); ?>"></script>
    <script src="<?php echo e(asset('jscript/cc-bi-report.js?n='.$javs)); ?>"></script>
