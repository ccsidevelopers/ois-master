    ...
    <div class="modal modal-info fade" id="modal-loading-bulk-endorse">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p style="text-align: center">Please wait while the endorsements are being submitted.  <img src="<?php echo e(asset('dist/img/loading.gif')); ?>" style="width: 5%;"></p>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class = "row">
                        ...
                        <div class = "col-md-6">
                            <center>
                                <img src="<?php echo e(asset('dist/img/loading.gif')); ?>" width="60%;" id="loadingGIF">
                            </center>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class ="col-md-2"></div>
                        <div class="col-md-8">
                            <h5>Please wait while sending the email notification...... <img src="<?php echo e(asset('dist/img/loading.gif')); ?>" style = "width : 3%" ></h5>
                        </div>
                        <div class ="col-md-2"></div>
                    </div>
                </div>
...
<?php $__env->startPush('leftsidebar'); ?>
    <?php echo $__env->make('bi_client.bi-client-leftsidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopPush(); ?>
...
<?php $__env->startPush('jscript'); ?>
    ...
    <script src="<?php echo e(asset('jscript/bi.js?n='.$javs)); ?>"></script>
    <script src="<?php echo e(asset('jscript/bi-billing.js?n='.$javs)); ?>"></script>
    <script src="<?php echo e(asset('jscript/bi-download-file-view-info.js?n='.$javs)); ?>"></script>
<?php $__env->stopPush(); ?>
