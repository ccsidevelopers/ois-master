                                    ...
                                    <div class="col-md-12">
                                        <div class="nav-tabs-custom">
                                            <ul class="nav nav-tabs">
                                                ...
                                                <?php if(Auth::user()->hasRole('Management') || Auth::user()->hasRole('Human Resources') || Auth::user()->hasRole('CC Senior Account Officer')): ?>
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane active" id="gen_att_tab1">
                                                    <div class="row">
                                                        ...
                                                        <?php if(Auth::user()->hasRole('Management') || Auth::user()->hasRole('Senior Account Officer') || Auth::user()->hasRole('CC Senior Account Officer') || Auth::user()->hasRole('Quality Analyst')): ?>
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="col-md-2">
