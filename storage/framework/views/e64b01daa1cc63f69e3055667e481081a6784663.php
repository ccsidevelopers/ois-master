                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group" id="dispose_attachment" hidden >
                                                            ...
                                                            <input type="file" class="disposeFilesTobeUploadBulk">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="" id="eq_mon_branch" class="form-control">
                                                                    ...
                                                                    <?php $__currentLoopData = $archipelagos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $archi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <option value="<?php echo e($archi->id); ?>"><?php echo e($archi->archipelago_name); ?></option>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="" id="eq_mon_item" class="form-control">
                                                                    <option value="">All</option>
                                                                    <?php $__currentLoopData = $item_selection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <option value="<?php echo e($items->item_type); ?>" name="<?php echo e($items->type); ?>"><?php echo e($items->item_type); ?></option>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select name="" id="inventory-employee-pos" class="select2" style="width: 100%">
                                                                                ...
                                                                                <?php $__currentLoopData = $position; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                    <option value="<?php echo e($pos->id); ?>"><?php echo e($pos->position_name); ?></option>
                                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                            </select>
                                                                        </div>
                                                                    </div>
