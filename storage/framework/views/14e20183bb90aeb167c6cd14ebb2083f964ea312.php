...
<div class="modal modal-info fade" id="modal-sendingrequest">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p style="text-align: center">Please wait while request is being sent.  <img src="<?php echo e(asset('dist/img/loading.gif')); ?>" style="width: 5%;"></p>
            </div>
            <div class="modal-footer">
...
<div class="modal modal-warning fade" id="modal-updating-accounts">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p style="text-align: center">Please wait while the accounts are being update.  <img src="<?php echo e(asset('dist/img/loading.gif')); ?>" style="width: 5%;"></p>
            </div>
            <div class="modal-footer">
            ...
            <div class="modal-body">
                ...
                <div id="row_1_unversal" class="row">
                    <div class="col-md-12 form-group">
                        <span class="text-black"><h5>ACCOUNT INFORMATION</h5></span>
                        <span id="view_info_details">
                        </span>
                    </div>
                </div>
                ...
                <div id="row_3_unversal" class="row">
                    <div class="col-md-12">
                        <span class="text-black"><h5>ACCOUNT LOGS</h5></span>
                    </div>
                </div>

                <div id="row_4_unversal" class="row">
                    <div class="col-md-12 form-group">
                        <table width="100%" id="view_info_account_logs">
                        </table>
                    </div>
                </div>
                ...
                <div id="row_direct_logs" class="row" hidden>
                    <div class="col-md-12">
                        <span class="text-black"><h5>DIRECT APPLICATION LOGS</h5></span>
                    </div>
                    <div class="col-md-12 form-group">
                    ...
                    <div class="col-md-12" style="padding-top : 15px;">
                        <div class="box box-default collapsed-box">
                            ...
                            <div class="box-body" style="display: none;">
                                <div class="row" style="padding-top : 20px; display: block; " id="show_hide_authorization_letter">
                                    <div class="col-md-12">
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12 form-group">
                        <center><img width="5%" src="<?php echo e(asset('/dist/img/loading.gif')); ?>"></center>
...
<div class="modal fade" id="modal-requisition_form" >
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
                <span id = "showHideSendRequestRequi" hidden><button type="button" class="btn btn-primary pull-right" id = "sendRequisitionToAdmin">Send Request <span id = "loadingSpanSendReq" hidden><img src="<?php echo e(asset('dist/img/loading.gif')); ?>" style="width: 7%; margin-left : 10px;"></span></button></span>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
                            ...
                            <div class="box-body">
                                ...
                                <div class = "row" style = "padding-top : 20px" id = "" >
                                    <div class = "col-md-12">
                                        ...
                                        <span id = "showApprovedReject_app" hidden><span class= "pull-right" ><button type="button" class="btn btn-success" id = "approveRequestReq_app">Approve Request <span id = "loadingSpanSendReqAppr1" hidden><img src="<?php echo e(asset('dist/img/loading.gif')); ?>" style="width: 7%; margin-left : 10px;"></span></button></span>
                                        <span class= "pull-right" style = "padding-right : 10px;" ><button type="button" class="btn btn-danger" id = "rejectRequestReq_app">Deny Request <span id = "loadingSpanSendReqAppr2" hidden><img src="<?php echo e(asset('dist/img/loading.gif')); ?>" style="width: 7%; margin-left : 10px;"></span></button></span></span>
