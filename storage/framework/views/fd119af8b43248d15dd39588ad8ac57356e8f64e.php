...
<div class="modal modal-info fade" id="modal-return">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Return Endorsement</h4>
            </div>
            <div class="modal-body">
                <center><p>Are you sure you want to Return this endorsement?</p></center>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-outline" id="btnReturn">Return Endorsement</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
...
<div class="modal modal-info fade" id="srao-modal-return">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
<div class="modal modal-info fade" id="srao-modal-cancelreturn">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Cancellation OF Return Endorsement</h4>
            </div>
            <div class="modal-body">
                <center><p>Are you sure you want to cancel return of this endorsement?</p></center>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-outline" id="btnReturnCancel">Cancel Return Endorsement</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
